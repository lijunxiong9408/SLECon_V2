...
#define NVADDR_IN_0_BITPOS						0x1880	// uc, ST6 input bit position
#define NVADDR_IN_1_BITPOS						0x1881	// uc, ST5 input bit position
#define NVADDR_IN_2_BITPOS						0x1882	// uc, ST1 input bit position
#define NVADDR_IN_3_BITPOS						0x1883	// uc, ST2 input bit position
#define NVADDR_IN_4_BITPOS						0x1884	// uc, ST3 input bit position
#define NVADDR_IN_5_BITPOS						0x1885	// uc, ST4 input bit position
#define NVADDR_IN_6_BITPOS						0x1886	// uc, ENCF input bit position
#define NVADDR_IN_7_BITPOS                      0x1887	// uc, NOP input bit position

#define NVADDR_IN_8_BITPOS						0x1888	// uc, DLB input bit position
#define NVADDR_IN_9_BITPOS						0x1889	// uc, ERO input bit position
#define NVADDR_IN_10_BITPOS                     0x188a	// uc, ERO_DOWN input bit position
#define NVADDR_IN_11_BITPOS                     0x188b	// uc, ERO_UP input bit position
#define NVADDR_IN_12_BITPOS						0x188c	// uc, USL input bit position
#define NVADDR_IN_13_BITPOS						0x188d	// uc, UDZ input bit position
#define NVADDR_IN_14_BITPOS						0x188e	// uc, LDZ input bit position
#define NVADDR_IN_15_BITPOS						0x188f	// uc, LSL input bit position

#define NVADDR_IN_16_BITPOS						0x1890	// uc, DI0 input bit position
#define NVADDR_IN_17_BITPOS						0x1891	// uc, DBDF input bit position
#define NVADDR_IN_18_BITPOS						0x1892	// uc, THM input bit position
#define NVADDR_IN_19_BITPOS						0x1893	// uc, UCMP input bit position
#define NVADDR_IN_20_BITPOS						0x1894	// uc, BS2 input bit position
#define NVADDR_IN_21_BITPOS						0x1895	// uc, LVCFB input bit position
#define NVADDR_IN_22_BITPOS						0x1896	// uc, DBDE input bit position
#define NVADDR_IN_23_BITPOS						0x1897	// uc, LVC1FB input bit position

#define NVADDR_IN_24_BITPOS                     0x1898	// uc, BK_MON input bit position
#define NVADDR_IN_25_BITPOS                     0x1899	// uc, DRV_OK input bit position
#define NVADDR_IN_26_BITPOS						0x189a	// uc, DI4 input bit position
#define NVADDR_IN_27_BITPOS						0x189b	// uc, DI2 input bit position
#define NVADDR_IN_28_BITPOS						0x189c	// uc, DI3 input bit position
#define NVADDR_IN_29_BITPOS						0x189d	// uc, EPB input bit position
#define NVADDR_IN_30_BITPOS						0x189e	// uc, DI1 input bit position
#define NVADDR_IN_31_BITPOS						0x189f	// uc, BS1 input bit position
#define NVADDR_IN_32_BITPOS						0x18a0	// uc, NOP input bit position
...
#define NVADDR_OUTBP_0							0x18f0	// uc,LVC output bit position
#define NVADDR_OUTBP_1							0x18f1	// uc, LVC1 output bit position
#define NVADDR_OUTBP_2							0x18f2	// uc, DO0 output bit position
#define NVADDR_OUTBP_3							0x18f3	// uc, SC_3 output bit position
#define NVADDR_OUTBP_4							0x18f4	// uc, SC_2 output bit position
#define NVADDR_OUTBP_5							0x18f5	// uc, SC_1 output bit position
#define NVADDR_OUTBP_6							0x18f6	// uc, GO output bit position
#define NVADDR_OUTBP_7							0x18f7	// uc, CCF output bit position
#define NVADDR_OUTBP_8							0x18f8	// uc, RBR output bit position
#define NVADDR_OUTBP_9							0x18f9	// uc, BR output bit position
#define NVADDR_OUTBP_10                         0x18fa	// uc, SPC output bit position
#define NVADDR_OUTBP_11							0x18fb	// uc, K1 output bit position
#define NVADDR_OUTBP_12							0x18fc	// uc, K2 output bit position
#define NVADDR_OUTBP_13							0x18fd	// uc, FWD output bit position
#define NVADDR_OUTBP_14							0x18fe	// uc, REV output bit position
#define NVADDR_OUTBP_15                         0x18ff	// uc, EPBoutput bit position

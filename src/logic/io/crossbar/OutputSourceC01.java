...
public enum OutputSourceC01 {
    ...
    private static HashMap<Integer, OutputSourceC01> outputSources = new HashMap<>();




    static {
        for ( OutputSourceC01 s : values() )
    ...
    OutputSourceC01 ( String text, int id ) {
        this.id       = id;
        this.fullname = String.format( "%s - %s", name(), text );
    }


    public static OutputSourceC01 getByID ( int id ) {

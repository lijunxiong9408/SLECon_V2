...
//    OCS_BOOTUP( 0x01, Level.CRITICAL, "OCS_BOOTUP.text" ),
    ...
    OCS_MODULE_EBP_LOAD( 0x0116, Level.GENERAL, "OCS_MODULE_EBP_LOAD.text" ),
    OCS_MODULE_EBP_UNLOAD( 0x0216, Level.GENERAL, "OCS_MODULE_EBP_UNLOAD.text" ),
    OCS_MODULE_EQO_LOAD( 0x0118, Level.GENERAL, "OCS_MODULE_EQO_LOAD.text" ),
    OCS_MODULE_EQO_UNLOAD( 0x0218, Level.GENERAL, "OCS_MODULE_EQO_UNLOAD.text" ),
    OCS_MODULE_FEO_LOAD( 0x010A, Level.GENERAL, "OCS_MODULE_FEO_LOAD.text" ),
    OCS_MODULE_FEO_UNLOAD( 0x020A, Level.GENERAL, "OCS_MODULE_FEO_UNLOAD.text" ),
    OCS_MODULE_FRO_LOAD( 0x0109, Level.GENERAL, "OCS_MODULE_FRO_LOAD.text" ),
    OCS_MODULE_FRO_UNLOAD( 0x0209, Level.GENERAL, "OCS_MODULE_FRO_UNLOAD.text" ),
    OCS_MODULE_TDEO_LOAD( 0x0108, Level.GENERAL, "OCS_MODULE_TDEO_LOAD.text" ),
    OCS_MODULE_TDEO_UNLOAD( 0x0208, Level.GENERAL, "OCS_MODULE_TDEO_UNLOAD.text" ),
	OCS_MODULE_MOH_LOAD( 0x011B, Level.GENERAL, "OCS_MODULE_MOH_LOAD.text" ),
    OCS_MODULE_MOH_UNLOAD( 0x021B, Level.GENERAL, "OCS_MODULE_MOH_UNLOAD.text" );

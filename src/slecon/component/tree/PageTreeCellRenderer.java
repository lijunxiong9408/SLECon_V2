 ...
 *
 */
public final class PageTreeCellRenderer extends DefaultTreeCellRenderer {
    ...
    public Component getTreeCellRendererComponent ( JTree tree, Object value, boolean selection, boolean expanded, boolean leaf, int row,
        ...
        if ( tree instanceof PageTree && value instanceof PageTreeItem ) {
            ...
            if ( ( ( PageTree )tree ).getSelectedPanelClass() != null
                && ( ( PageTree )tree ).getSelectedPanelClass().equals( ( ( PageTreeItem )value ).getPanelClass() ) ) {                

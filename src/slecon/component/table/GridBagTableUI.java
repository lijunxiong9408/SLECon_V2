...
public class GridBagTableUI extends BasicTableUI {
    ...
    public void paint ( Graphics g, JComponent c ) {
        ...
        Point lowerRight = new Point( clip.x + clip.width - ( ltr
                                                              ? 1
                                                              : 0 ), clip.y + clip.height );
    ...
    /*
     * Paints the grid lines within <I>aRect</I>, using the grid color set with <I>setGridColor</I>. Paints vertical lines if
     * <code>getShowVerticalLines()</code> returns true and paints horizontal lines if <code>getShowHorizontalLines()</code> returns true.
     */

...
public class SetupTree extends PageTree {
    private static final long                  serialVersionUID = -3958713129443731233L;
    ...
    protected synchronized void initTreeItem () {
        ...
        if (getConnectionBean() != null) {
            for (DisplayTreeItem item : PageLookup.getSetupPageClass()) {

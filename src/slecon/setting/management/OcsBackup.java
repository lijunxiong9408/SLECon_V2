...
/**
 * Input/export OCS Data file
 *
 */
public class OcsBackup extends JPanel implements ActionListener {
     ...
     * Text resource.
     */
    private static final ResourceBundle TEXT = ToolBox.getResourceBundle( "setting.management.OcsBackup" );
    
    private boolean                 started = false;
    private SettingPanel<OcsBackup> 	settingPanel;
    private JLabel                  cpt_backup;
    ...
    public void setSettingPanel ( SettingPanel<OcsBackup> panel ) {
    ...
    private void initGUI () {
        ...
        setCaptionStyle(cpt_backup);
        setTextLabelStyle(cpt_backup_type);
        setTextLabelStyle(cpt_file);
        
        add( cpt_backup, "gapbottom 18-12, span, aligny center" );
    ...
    private void loadI18N () {
    	...
    	cpt_backup.setText( getBundleText( "LBL_cpt_backup", "Backup OCS" ) );
    	cpt_file.setText( getBundleText( "LBL_cpt_file", "file" ) );
    	btn_file.setText( getBundleText( "LBL_btn_file", "Update NVRAM" ) );
    ...
    public static OcsBackup createPanel ( SettingPanel<OcsBackup> panel ) {
        OcsBackup gui = new OcsBackup();
        gui.initGUI();

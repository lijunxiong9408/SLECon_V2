...
import logic.io.crossbar.InputPinA01;
...
public class InputsA01 extends JPanel {
    private static final long      serialVersionUID = 6592660277537767456L;
    
    private static final ResourceBundle TEXT             = ToolBox.getResourceBundle( "setting.io.InputsA01" );
    ...
    private SettingPanel<InputsA01> settingPanel;
    ...
    private JLabel                        lbl_line_di1;
    private MyComboBox        		      cbo_line_di1;
    private MyCheckBox                     chk_line_di1;
    private JLabel                        state_line_di1;
    
    private JLabel                        lbl_line_di2;
    private MyComboBox        		      cbo_line_di2;
    private MyCheckBox                     chk_line_di2;
    private JLabel                        state_line_di2;
    
    private JLabel                        lbl_line_di3;
    private MyComboBox        		      cbo_line_di3;
    private MyCheckBox                     chk_line_di3;
    private JLabel                        state_line_di3;
    
    private JLabel                        lbl_line_di4;
    private MyComboBox        		      cbo_line_di4;
    private MyCheckBox                     chk_line_di4;
    private JLabel                        state_line_di4;

    private HashMap<InputPinA01, Boolean> inputPinState;
    ...
    public void setSettingPanel ( SettingPanel<InputsA01> panel ) {
    ...
    public void SetJComboBoxEnable(boolean Enable) {
    	...
    	this.cbo_line_di1.setEnabled(Enable);
    	this.cbo_line_di2.setEnabled(Enable);
    	this.cbo_line_di3.setEnabled(Enable);
    	this.cbo_line_di4.setEnabled(Enable);
    }
    ...
    private void initGUI () {
        ...
        cbo_line_insdown.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        ...
        cbo_line_drvok.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        chk_line_drvok   = new MyCheckBox();
        state_line_drvok = new JLabel( GRAY_ICON );
        lbl_line_drvbm   = new JLabel();
        cbo_line_drvbm   = new MyComboBox();
        cbo_line_drvbm.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        ...
        cbo_line_ucmts2.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        ...
        cbo_line_ucmts3.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        chk_line_ucmts3   = new MyCheckBox();
        state_line_ucmts3 = new JLabel( GRAY_ICON );
        lbl_line_dlb = new JLabel();
        cbo_line_dlb = new MyComboBox();
        cbo_line_dlb.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        chk_line_dlb = new MyCheckBox();
        state_line_dlb = new JLabel( GRAY_ICON );
        lbl_line_di1 = new JLabel();
        cbo_line_di1 = new MyComboBox();
        cbo_line_di1.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        chk_line_di1 = new MyCheckBox();
        state_line_di1 = new JLabel( GRAY_ICON );
        lbl_line_di2 = new JLabel();
        cbo_line_di2 = new MyComboBox();
        cbo_line_di2.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        chk_line_di2 = new MyCheckBox();
        state_line_di2 = new JLabel( GRAY_ICON );
        lbl_line_di3 = new JLabel();
        cbo_line_di3 = new MyComboBox();
        cbo_line_di3.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        chk_line_di3 = new MyCheckBox();
        state_line_di3 = new JLabel( GRAY_ICON );
        lbl_line_di4 = new JLabel();
        cbo_line_di4 = new MyComboBox();
        cbo_line_di4.setModel( new DefaultComboBoxModel<>( InputPinA01.allDisplayItem() ) );
        chk_line_di4 = new MyCheckBox();
        state_line_di4 = new JLabel( GRAY_ICON );
        ...
        setLabelTitleStyle( lbl_line_di1 );
        setComboBoxValueStyle( cbo_line_di1 );
        setCheckBoxStyle( chk_line_di1 );
        setLabelTitleStyle( lbl_line_di2 );
        setComboBoxValueStyle( cbo_line_di2 );
        setCheckBoxStyle( chk_line_di2 );
        setLabelTitleStyle( lbl_line_di3 );
        setComboBoxValueStyle( cbo_line_di3 );
        setCheckBoxStyle( chk_line_di3 );
        setLabelTitleStyle( lbl_line_di4 );
        setComboBoxValueStyle( cbo_line_di4 );
        setCheckBoxStyle( chk_line_di4 );
        ...
        add( lbl_line_enable, "cell 2 11" );
        add( cbo_line_enable, "cell 3 11" );
        add( chk_line_enable, "center, cell 4 11" );
        add( state_line_enable, "center, cell 5 11" );
        ...
        add( lbl_line_di1, "cell 2 32" );
        add( cbo_line_di1, "cell 3 32" );
        add( chk_line_di1, "center, cell 4 32" );
        add( state_line_di1, "center, cell 5 32" );
        add( lbl_line_di2, "cell 2 33" );
        add( cbo_line_di2, "cell 3 33" );
        add( chk_line_di2, "center, cell 4 33" );
        add( state_line_di2, "center, cell 5 33" );
        add( lbl_line_di3, "cell 2 34" );
        add( cbo_line_di3, "cell 3 34" );
        add( chk_line_di3, "center, cell 4 34" );
        add( state_line_di3, "center, cell 5 34" );
        add( lbl_line_di4, "cell 2 35" );
        add( cbo_line_di4, "cell 3 35" );
        add( chk_line_di4, "center, cell 4 35" );
        add( state_line_di4, "center, cell 5 35" );
        ...
        cbo_line_di1.addItemListener(icl);
        cbo_line_di2.addItemListener(icl);
        cbo_line_di3.addItemListener(icl);
        cbo_line_di4.addItemListener(icl);
        ...
        chk_line_di1.addActionListener( icl );
        chk_line_di2.addActionListener( icl );
        chk_line_di3.addActionListener( icl );
        chk_line_di4.addActionListener( icl );
        ...
        //bindGroup( "DI1", lbl_line_di1, cbo_line_di1, chk_line_di1, state_line_di1 );
        //bindGroup( "DI2", lbl_line_di2, cbo_line_di2, chk_line_di2, state_line_di2 );
        //bindGroup( "DI3", lbl_line_di3, cbo_line_di3, chk_line_di3, state_line_di3 );
        //bindGroup( "DI4", lbl_line_di4, cbo_line_di4, chk_line_di4, state_line_di4 );
    ...
    private void loadI18N () {
        ...
        lbl_line_di1.setText( "DI1" );
        lbl_line_di2.setText( "DI2" );
        lbl_line_di3.setText( "DI3" );
        lbl_line_di4.setText( "DI4" );
    }
    ...
    public InputPinBean getInputPinBean () throws ConvertException {
        ...
        bean_inputPin.setUsl( ( InputPinA01 )cbo_line_usl.getSelectedItem() );
        bean_inputPin.setLsl( ( InputPinA01 )cbo_line_lsl.getSelectedItem() );
        bean_inputPin.setUdz( ( InputPinA01 )cbo_line_udz.getSelectedItem() );
        bean_inputPin.setLdz( ( InputPinA01 )cbo_line_ldz.getSelectedItem() );
        bean_inputPin.setIns( ( InputPinA01 )cbo_line_ins.getSelectedItem() );
        bean_inputPin.setInsUp( ( InputPinA01 )cbo_line_insup.getSelectedItem() );
        bean_inputPin.setInsDown( ( InputPinA01 )cbo_line_insdown.getSelectedItem() );
        bean_inputPin.setDrvOK( ( InputPinA01 )cbo_line_drvok.getSelectedItem() );
        bean_inputPin.setDrvBM( ( InputPinA01 )cbo_line_drvbm.getSelectedItem() );
        bean_inputPin.setEnable( ( InputPinA01 )cbo_line_enable.getSelectedItem() );
        bean_inputPin.setDbdf( ( InputPinA01 )cbo_line_dbdf.getSelectedItem() );
        bean_inputPin.setBs1( ( InputPinA01 )cbo_line_bs1.getSelectedItem() );
        bean_inputPin.setBs2( ( InputPinA01 )cbo_line_bs2.getSelectedItem() );
        bean_inputPin.setSt1( ( InputPinA01 )cbo_line_st1.getSelectedItem() );
        bean_inputPin.setSt2( ( InputPinA01 )cbo_line_st2.getSelectedItem() );
        bean_inputPin.setSt3( ( InputPinA01 )cbo_line_st3.getSelectedItem() );
        bean_inputPin.setSt4( ( InputPinA01 )cbo_line_st4.getSelectedItem() );
        bean_inputPin.setSt5( ( InputPinA01 )cbo_line_st5.getSelectedItem() );
        bean_inputPin.setSt6( ( InputPinA01 )cbo_line_st6.getSelectedItem() );
        bean_inputPin.setLvcfb( ( InputPinA01 )cbo_line_lvcfb.getSelectedItem() );
        bean_inputPin.setLvc1fb( ( InputPinA01 )cbo_line_lvc1fb.getSelectedItem() );
        bean_inputPin.setThm( ( InputPinA01 )cbo_line_thm.getSelectedItem() );
        bean_inputPin.setEncf( ( InputPinA01 )cbo_line_encf.getSelectedItem() );
        bean_inputPin.setUrl( ( InputPinA01 )cbo_line_url.getSelectedItem() );
        bean_inputPin.setLrl( ( InputPinA01 )cbo_line_lrl.getSelectedItem() );
        bean_inputPin.setEpb( ( InputPinA01 )cbo_line_epb.getSelectedItem() );
        bean_inputPin.setUcmts( ( InputPinA01 )cbo_line_ucmts.getSelectedItem() );
        bean_inputPin.setUcmts2( ( InputPinA01 )cbo_line_ucmts2.getSelectedItem() );
        bean_inputPin.setDlb( ( InputPinA01 )cbo_line_dlb.getSelectedItem() );
        bean_inputPin.setDi1( ( InputPinA01 )cbo_line_di1.getSelectedItem() );
        bean_inputPin.setDi2( ( InputPinA01 )cbo_line_di2.getSelectedItem() );
        bean_inputPin.setDi3( ( InputPinA01 )cbo_line_di3.getSelectedItem() );
        bean_inputPin.setDi4( ( InputPinA01 )cbo_line_di4.getSelectedItem() );
        ...
        bean_inputPin.setDi1Inverted(chk_line_di1.isSelected());
        bean_inputPin.setDi2Inverted(chk_line_di2.isSelected());
        bean_inputPin.setDi3Inverted(chk_line_di3.isSelected());
        bean_inputPin.setDi4Inverted(chk_line_di4.isSelected());
    ...
    public void setInputPinBean ( InputPinBean bean_inputPin ) {
        final InputPinA01[] items = InputPinA01.allDisplayItem(bean_inputPin.firmwareVersion);
        ...
        cbo_line_di1.setModel( new DefaultComboBoxModel<>( items ) );
        cbo_line_di2.setModel( new DefaultComboBoxModel<>( items ) );
        cbo_line_di3.setModel( new DefaultComboBoxModel<>( items ) );
        cbo_line_di4.setModel( new DefaultComboBoxModel<>( items ) );
		
        List<InputPinA01> list = Arrays.asList( items );
        ...
        this.cbo_line_st1.setSelectedItem( list.contains( bean_inputPin.getSt1() ) ? bean_inputPin.getSt1() : null );
        this.cbo_line_st2.setSelectedItem( list.contains( bean_inputPin.getSt2() ) ? bean_inputPin.getSt2() : null );
        this.cbo_line_st3.setSelectedItem( list.contains( bean_inputPin.getSt3() ) ? bean_inputPin.getSt3() : null );
        this.cbo_line_st4.setSelectedItem( list.contains( bean_inputPin.getSt4() ) ? bean_inputPin.getSt4() : null );
        this.cbo_line_st5.setSelectedItem( list.contains( bean_inputPin.getSt5() ) ? bean_inputPin.getSt5() : null );
        this.cbo_line_st6.setSelectedItem( list.contains( bean_inputPin.getSt6() ) ? bean_inputPin.getSt6() : null );
        this.cbo_line_lvcfb.setSelectedItem( list.contains( bean_inputPin.getLvcfb() ) ? bean_inputPin.getLvcfb() : null );
        this.cbo_line_lvc1fb.setSelectedItem( list.contains( bean_inputPin.getLvc1fb() ) ? bean_inputPin.getLvc1fb() : null );
        ...
        this.cbo_line_di1.setSelectedItem( list.contains( bean_inputPin.getDi1() ) ? bean_inputPin.getDi1() : null );
        this.cbo_line_di2.setSelectedItem( list.contains( bean_inputPin.getDi2() ) ? bean_inputPin.getDi2() : null );
        this.cbo_line_di3.setSelectedItem( list.contains( bean_inputPin.getDi3() ) ? bean_inputPin.getDi3() : null );
        this.cbo_line_di4.setSelectedItem( list.contains( bean_inputPin.getDi4() ) ? bean_inputPin.getDi4() : null );
        ...
        this.chk_line_di1.setSelected( bean_inputPin.isDi1Inverted() );
        this.chk_line_di2.setSelected( bean_inputPin.isDi2Inverted() );
        this.chk_line_di3.setSelected( bean_inputPin.isDi3Inverted() );
        this.chk_line_di4.setSelected( bean_inputPin.isDi4Inverted() );
        
    }


    public static InputsA01 createPanel ( SettingPanel<InputsA01> panel ) {
        InputsA01 gui = new InputsA01();
    ...
    public static void main ( String... arg ) {
        ...
        f.getContentPane().add( new InputsA01() );
        f.pack();
        f.setVisible( true );
    }
    ...
    public void setInputPinState ( HashMap<InputPinA01, Boolean> inputPinState ) {
    ...
    private void updateInputPinState () {
        ...
        if ( bean != null ) {
            ...
            state_line_di1.setIcon( toIcon( bean != null && bean.getDi1() == null
						                    ? null
						                    : logicalXOR( chk_line_di1.isSelected(), inputPinState.get( bean.getDi1() ) ) ) );
            state_line_di2.setIcon( toIcon( bean != null && bean.getDi2() == null
						                    ? null
						                    : logicalXOR( chk_line_di2.isSelected(), inputPinState.get( bean.getDi2() ) ) ) );
            state_line_di3.setIcon( toIcon( bean != null && bean.getDi3() == null
						                    ? null
						                    : logicalXOR( chk_line_di3.isSelected(), inputPinState.get( bean.getDi3() ) ) ) );
            state_line_di4.setIcon( toIcon( bean != null && bean.getDi4() == null
						                    ? null
						                    : logicalXOR( chk_line_di4.isSelected(), inputPinState.get( bean.getDi4() ) ) ) );
    ...
    public static class InputPinBean {
        ...
        private InputPinA01 usl;
        private InputPinA01 lsl;
        private InputPinA01 udz;
        private InputPinA01 ldz;
        private InputPinA01 ins;
        private InputPinA01 insUp;
        private InputPinA01 insDown;
        private InputPinA01 drvOK;
        private InputPinA01 drvBM;
        private InputPinA01 enable;
        private InputPinA01 dbdf;
        private InputPinA01 bs1;
        private InputPinA01 bs2;
        private InputPinA01 st1;
        private InputPinA01 st2;
        private InputPinA01 st3;
        private InputPinA01 st4;
        private InputPinA01 st5;
        private InputPinA01 st6;
        private InputPinA01 lvcfb;
        private InputPinA01 lvc1fb;
        private InputPinA01 thm;
        private InputPinA01 encf;
        private InputPinA01 url;
        private InputPinA01 lrl;
        private InputPinA01 epb;
        private InputPinA01 ucmts;
        private InputPinA01 ucmts2;
        private InputPinA01 ucmts3;
        private InputPinA01 dlb;
        private InputPinA01 di1;
        private InputPinA01 di2;
        private InputPinA01 di3;
        private InputPinA01 di4;
        ...
        private boolean     di1Inverted;
        private boolean     di2Inverted;
        private boolean     di3Inverted;
        private boolean     di4Inverted;
		...
		public boolean isDi1Inverted() {
			return di1Inverted;
		}


		public boolean isDi2Inverted() {
			return di2Inverted;
		}


		public boolean isDi3Inverted() {
			return di3Inverted;
		}


		public boolean isDi4Inverted() {
			return di4Inverted;
		}
...
//---------------------------------------------------------------------
		...
		public void setDi1Inverted(boolean di1Inverted) {
			this.di1Inverted = di1Inverted;
		}


		public void setDi2Inverted(boolean di2Inverted) {
			this.di2Inverted = di2Inverted;
		}


		public void setDi3Inverted(boolean di3Inverted) {
			this.di3Inverted = di3Inverted;
		}


		public void setDi4Inverted(boolean di4Inverted) {
			this.di4Inverted = di4Inverted;
		}

//---------------------------------------------------------------------
		public InputPinA01 getUsl () {
            return usl;
        }


        public InputPinA01 getLsl () {
            return lsl;
        }


        public InputPinA01 getUdz () {
            return udz;
        }


        public InputPinA01 getLdz () {
            return ldz;
        }


        public InputPinA01 getIns () {
            return ins;
        }


        public InputPinA01 getInsUp () {
            return insUp;
        }


        public InputPinA01 getInsDown () {
            return insDown;
        }


        public InputPinA01 getDrvOK () {
            return drvOK;
        }


        public InputPinA01 getDrvBM () {
            return drvBM;
        }


        public InputPinA01 getEnable () {
            return enable;
        }


        public InputPinA01 getDbdf () {
            return dbdf;
        }


        public InputPinA01 getBs1 () {
            return bs1;
        }
        
        public InputPinA01 getBs2 () {
            return bs2;
        }

        
        public InputPinA01 getSt1() {
			return st1;
		}


		public InputPinA01 getSt2() {
			return st2;
		}


		public InputPinA01 getSt3() {
			return st3;
		}


		public InputPinA01 getSt4() {
			return st4;
		}


		public InputPinA01 getSt5() {
			return st5;
		}


		public InputPinA01 getSt6() {
			return st6;
		}


		public InputPinA01 getLvcfb () {
            return lvcfb;
        }


        public InputPinA01 getLvc1fb() {
			return lvc1fb;
		}


		public InputPinA01 getThm () {
            return thm;
        }


        public InputPinA01 getEncf () {
            return encf;
        }


        public final InputPinA01 getUrl() {
            return url;
        }


        public final InputPinA01 getLrl() {
            return lrl;
        }
        
        
        public InputPinA01 getEpb() {
			return epb;
		}
        

		public InputPinA01 getUcmts() {
			return ucmts;
		}


		public InputPinA01 getUcmts2() {
			return ucmts2;
		}


		public InputPinA01 getUcmts3() {
			return ucmts3;
		}


		public InputPinA01 getDlb() {
			return dlb;
		}


		public InputPinA01 getDi1() {
			return di1;
		}


		public InputPinA01 getDi2() {
			return di2;
		}


		public InputPinA01 getDi3() {
			return di3;
		}


		public InputPinA01 getDi4() {
			return di4;
		}


		public void setUsl ( InputPinA01 usl ) {
            this.usl = usl;
        }


        public void setLsl ( InputPinA01 lsl ) {
            this.lsl = lsl;
        }


        public void setUdz ( InputPinA01 udz ) {
            this.udz = udz;
        }


        public void setLdz ( InputPinA01 ldz ) {
            this.ldz = ldz;
        }


        public void setIns ( InputPinA01 ins ) {
            this.ins = ins;
        }


        public void setInsUp ( InputPinA01 insUp ) {
            this.insUp = insUp;
        }


        public void setInsDown ( InputPinA01 insDown ) {
            this.insDown = insDown;
        }


        public void setDrvOK ( InputPinA01 drvOK ) {
            this.drvOK = drvOK;
        }


        public void setDrvBM ( InputPinA01 drvBM ) {
            this.drvBM = drvBM;
        }


        public void setEnable ( InputPinA01 enable ) {
            this.enable = enable;
        }


        public void setDbdf ( InputPinA01 dbdf ) {
            this.dbdf = dbdf;
        }


        public void setBs1 ( InputPinA01 bs ) {
            this.bs1 = bs;
        }

        
        public void setBs2 ( InputPinA01 bs ) {
            this.bs2 = bs;
        }
        
        
        public void setSt1 ( InputPinA01 st1 ) {
        	this.st1 = st1;
        }
        
        
        public void setSt2 ( InputPinA01 st2 ) {
            this.st2 = st2;
        }

        
        public void setSt3(InputPinA01 st3) {
			this.st3 = st3;
		}


		public void setSt4(InputPinA01 st4) {
			this.st4 = st4;
		}


		public void setSt5(InputPinA01 st5) {
			this.st5 = st5;
		}


		public void setSt6(InputPinA01 st6) {
			this.st6 = st6;
		}


		public void setLvcfb ( InputPinA01 lvcfb ) {
            this.lvcfb = lvcfb;
        }

		
        public void setLvc1fb(InputPinA01 lvc1fb) {
			this.lvc1fb = lvc1fb;
		}


		public void setThm ( InputPinA01 thm ) {
            this.thm = thm;
        }


        public void setEncf ( InputPinA01 encf ) {
            this.encf = encf;
        }


        public final void setUrl(InputPinA01 url) {
            this.url = url;
        }


        public final void setLrl(InputPinA01 lrl) {
            this.lrl = lrl;
        }


		public void setEpb(InputPinA01 epb) {
			this.epb = epb;
		}

		public void setUcmts(InputPinA01 ucmts) {
			this.ucmts = ucmts;
		}

		public void setUcmts2(InputPinA01 ucmts2) {
			this.ucmts2 = ucmts2;
		}

		public void setUcmts3(InputPinA01 ucmts3) {
			this.ucmts3 = ucmts3;
		}


		public void setDlb(InputPinA01 dlb) {
			this.dlb = dlb;
		}


		public void setDi1(InputPinA01 di1) {
			this.di1 = di1;
		}


		public void setDi2(InputPinA01 di2) {
			this.di2 = di2;
		}


		public void setDi3(InputPinA01 di3) {
			this.di3 = di3;
		}


		public void setDi4(InputPinA01 di4) {
			this.di4 = di4;
		}
    ...
    public class ItemChangedListener implements ActionListener, ItemListener {
        public void itemStateChanged ( ItemEvent e ) {
            if ( settingPanel instanceof InputsA01Setting ) {
                ( ( InputsA01Setting )settingPanel ).updateStatus();
            }
        }

...
public class OutputsA03 extends JPanel {
    ...
    private SettingPanel<OutputsA03>   settingPanel;
    ...
    public void setSettingPanel ( SettingPanel<OutputsA03> panel ) {
    ...
    public static OutputsA03 createPanel ( SettingPanel<OutputsA03> panel ) {
        OutputsA03 gui = new OutputsA03();
    ...
    public void setOutputSourceState ( HashMap<OutputPinA03, Boolean> result ) {
        state_rl1.setIcon( toIcon( result.get( OutputPinA03.RL1 ) ) );
        state_rl2.setIcon( toIcon( result.get( OutputPinA03.RL2 ) ) );
        state_rl3.setIcon( toIcon( result.get( OutputPinA03.RL3 ) ) );
        state_rl4.setIcon( toIcon( result.get( OutputPinA03.RL4 ) ) );
        state_rl5.setIcon( toIcon( result.get( OutputPinA03.RL5 ) ) );
        state_rl6.setIcon( toIcon( result.get( OutputPinA03.RL6 ) ) );
        state_rl10.setIcon( toIcon( result.get( OutputPinA03.RL10 ) ) );
        state_p101.setIcon( toIcon( result.get( OutputPinA03.P10_1 ) ) );
        state_p102.setIcon( toIcon( result.get( OutputPinA03.P10_2 ) ) );
        state_p103.setIcon( toIcon( result.get( OutputPinA03.P10_3 ) ) );
        state_p104.setIcon( toIcon( result.get( OutputPinA03.P10_4 ) ) );
        state_p105.setIcon( toIcon( result.get( OutputPinA03.P10_5 ) ) );
        state_p106.setIcon( toIcon( result.get( OutputPinA03.P10_6 ) ) );
        state_p107.setIcon( toIcon( result.get( OutputPinA03.P10_7 ) ) );
    }

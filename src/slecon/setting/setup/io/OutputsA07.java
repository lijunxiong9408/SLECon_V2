...
public class OutputsA07 extends JPanel {
    private static final long      serialVersionUID = -6123382229791452623L;
    
    private static final ResourceBundle TEXT             = ToolBox.getResourceBundle( "setting.io.OutputsA07" );
    ...
    private SettingPanel<OutputsA07>   settingPanel;
    ...
    public void setSettingPanel ( SettingPanel<OutputsA07> panel ) {
    ...
    public static OutputsA07 createPanel ( SettingPanel<OutputsA07> panel ) {
        OutputsA07 gui = new OutputsA07();
    ...
    public void setOutputSourceState ( HashMap<OutputPinA07, Boolean> result ) {
        state_rl1.setIcon( toIcon( result.get( OutputPinA07.RL1 ) ) );
        state_rl2.setIcon( toIcon( result.get( OutputPinA07.RL2 ) ) );
        state_rl3.setIcon( toIcon( result.get( OutputPinA07.RL3 ) ) );
        state_rl4.setIcon( toIcon( result.get( OutputPinA07.RL4 ) ) );
        state_rl5.setIcon( toIcon( result.get( OutputPinA07.RL5 ) ) );
        state_rl6.setIcon( toIcon( result.get( OutputPinA07.RL6 ) ) );
        state_rl10.setIcon( toIcon( result.get( OutputPinA07.RL10 ) ) );
        state_p101.setIcon( toIcon( result.get( OutputPinA07.P10_1 ) ) );
        state_p102.setIcon( toIcon( result.get( OutputPinA07.P10_2 ) ) );
        state_p103.setIcon( toIcon( result.get( OutputPinA07.P10_3 ) ) );
        state_p104.setIcon( toIcon( result.get( OutputPinA07.P10_4 ) ) );
        state_p105.setIcon( toIcon( result.get( OutputPinA07.P10_5 ) ) );
        state_p106.setIcon( toIcon( result.get( OutputPinA07.P10_6 ) ) );
        state_p107.setIcon( toIcon( result.get( OutputPinA07.P10_7 ) ) );
    }

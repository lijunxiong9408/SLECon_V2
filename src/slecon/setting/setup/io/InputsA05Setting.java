...
@SetupView(
    ...
    sortIndex = 0x231,
    condition = "lift.version.mcsBoardVersion=='A05'"
)
public class InputsA05Setting extends SettingPanel<InputsA05> implements Page, LiftDataChangedListener {
     ...
     * Logger.
     */
    private final Logger logger = LogManager.getLogger(InputsA05Setting.class);
    ...
    public InputsA05Setting ( LiftConnectionBean connBean ) {
        super(connBean);
    ...
    @Override
    public void onOK(InputsA05 panel) {
        synchronized ( mutex  ) {
            setEnabled(false);
            if ( submit() )
                solid = null;
    ...
    @Override
    public void onReset(InputsA05 panel) {
	...
	protected LinkedHashMap<String, Class<? extends JPanel>> getNavigation() {
		...
		map.put(Dict.lookup("I/O"), slecon.setting.setup.io.InputsA05Setting.class);
    ...
    private static final class Solid {
        private InputsA05.InputPinBean bean;

        private Solid(InputsA05.InputPinBean bean) {
            super();
            this.bean = bean;
        }
    }
    ...
    public void setHot() {
        ...
        try {
            final InputsA05.InputPinBean bean = new InputsA05.InputPinBean();
            ...
            bean.setFirmwareVersion(mcsconfig.getFirmwareVersion());
            {
                ...
                int code = raw & 0x7f;
                bean.setUsl(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLsl(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUdz(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLdz(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setIns(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setInsUp(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setInsDown(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvOK(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvBM(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvENF(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEnable(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDbde(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDbdf(InputPinA05.getByRawIOPosition(code));
                bean.setDbdfInverted(isInverted);
            }
            {
                // NVADDR_IN_BS1_BITPOS 0x188b (uc)
                int raw = nvram.getUnsignedByte(NVAddress.NVADDR_IN_BS1_BITPOS.address).intValue();
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setBs1(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setBs2(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDfc(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDw(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setHes(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setCes(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLvcfb(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setThm(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEncf(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUrl(InputPinA05.getByRawIOPosition(code)); 
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLrl(InputPinA05.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEpb(InputPinA05.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts(InputPinA05.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts2(InputPinA05.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts3(InputPinA05.getByRawIOPosition(code));
    ...
    public boolean submit() {
    	if(IsVerify) {
    		try {
	            InputsA05.InputPinBean bean = app.getInputPinBean();
    ...
    public void updateStatus () {
        final HashMap<InputPinA05, Boolean> result   = new HashMap<>();
        CrossBar                            crossbar = new CrossBar( mcsconfig.getCrossbar() );
        byte[]                              rawIO    = status.getMcsIO();
        for ( InputPinA05 pin : InputPinA05.values() ) {

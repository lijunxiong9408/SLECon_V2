...
import logic.io.crossbar.InputPinA05;
...
public class InputsA05 extends JPanel {
    private static final long      serialVersionUID = 6592660277537767456L;
    
    private static final ResourceBundle TEXT             = ToolBox.getResourceBundle( "setting.io.InputsA05" );
    ...
    private SettingPanel<InputsA05> settingPanel;
    ...
    private HashMap<InputPinA05, Boolean> inputPinState;
    ...
    public void setSettingPanel ( SettingPanel<InputsA05> panel ) {
    ...
    private void initGUI () {
        ...
        cbo_line_insdown.setModel( new DefaultComboBoxModel<>( InputPinA05.allDisplayItem() ) );
        ...
        cbo_line_drvok.setModel( new DefaultComboBoxModel<>( InputPinA05.allDisplayItem() ) );
        chk_line_drvok   = new MyCheckBox();
        state_line_drvok = new JLabel( GRAY_ICON );
        lbl_line_drvbm   = new JLabel();
        cbo_line_drvbm   = new MyComboBox();
        cbo_line_drvbm.setModel( new DefaultComboBoxModel<>( InputPinA05.allDisplayItem() ) );
        ...
        cbo_line_drvenf.setModel( new DefaultComboBoxModel<>( InputPinA05.allDisplayItem() ) );
        ...
        cbo_line_ucmts2.setModel( new DefaultComboBoxModel<>( InputPinA05.allDisplayItem() ) );
        ...
        cbo_line_ucmts3.setModel( new DefaultComboBoxModel<>( InputPinA05.allDisplayItem() ) );
    ...
    public InputPinBean getInputPinBean () throws ConvertException {
        ...
        bean_inputPin.setUsl( ( InputPinA05 )cbo_line_usl.getSelectedItem() );
        bean_inputPin.setLsl( ( InputPinA05 )cbo_line_lsl.getSelectedItem() );
        bean_inputPin.setUdz( ( InputPinA05 )cbo_line_udz.getSelectedItem() );
        bean_inputPin.setLdz( ( InputPinA05 )cbo_line_ldz.getSelectedItem() );
        bean_inputPin.setIns( ( InputPinA05 )cbo_line_ins.getSelectedItem() );
        bean_inputPin.setInsUp( ( InputPinA05 )cbo_line_insup.getSelectedItem() );
        bean_inputPin.setInsDown( ( InputPinA05 )cbo_line_insdown.getSelectedItem() );
        bean_inputPin.setDrvOK( ( InputPinA05 )cbo_line_drvok.getSelectedItem() );
        bean_inputPin.setDrvBM( ( InputPinA05 )cbo_line_drvbm.getSelectedItem() );
        bean_inputPin.setDrvENF( ( InputPinA05 )cbo_line_drvenf.getSelectedItem() );
        bean_inputPin.setEnable( ( InputPinA05 )cbo_line_enable.getSelectedItem() );
        bean_inputPin.setDbde( ( InputPinA05 )cbo_line_dbde.getSelectedItem() );
        bean_inputPin.setDbdf( ( InputPinA05 )cbo_line_dbdf.getSelectedItem() );
        bean_inputPin.setBs1( ( InputPinA05 )cbo_line_bs1.getSelectedItem() );
        bean_inputPin.setBs2( ( InputPinA05 )cbo_line_bs2.getSelectedItem() );
        bean_inputPin.setDfc( ( InputPinA05 )cbo_line_dfc.getSelectedItem() );
        bean_inputPin.setDw( ( InputPinA05 )cbo_line_dw.getSelectedItem() );
        bean_inputPin.setHes( ( InputPinA05 )cbo_line_hes.getSelectedItem() );
        bean_inputPin.setCes( ( InputPinA05 )cbo_line_ces.getSelectedItem() );
        bean_inputPin.setLvcfb( ( InputPinA05 )cbo_line_lvcfb.getSelectedItem() );
        bean_inputPin.setThm( ( InputPinA05 )cbo_line_thm.getSelectedItem() );
        bean_inputPin.setEncf( ( InputPinA05 )cbo_line_encf.getSelectedItem() );
        bean_inputPin.setUrl( ( InputPinA05 )cbo_line_url.getSelectedItem() );
        bean_inputPin.setLrl( ( InputPinA05 )cbo_line_lrl.getSelectedItem() );
        bean_inputPin.setEpb( ( InputPinA05 )cbo_line_epb.getSelectedItem() );
        bean_inputPin.setUcmts( ( InputPinA05 )cbo_line_ucmts.getSelectedItem() );
        bean_inputPin.setUcmts2( ( InputPinA05 )cbo_line_ucmts2.getSelectedItem() );
        bean_inputPin.setUcmts3( ( InputPinA05 )cbo_line_ucmts3.getSelectedItem() );
    ...
    public void setInputPinBean ( InputPinBean bean_inputPin ) {
        final InputPinA05[] items = InputPinA05.allDisplayItem(bean_inputPin.firmwareVersion);
        ...
        List<InputPinA05> list = Arrays.asList( items );
    ...
    public static InputsA05 createPanel ( SettingPanel<InputsA05> panel ) {
        InputsA05 gui = new InputsA05();
    ...
    public static void main ( String... arg ) {
        ...
        f.getContentPane().add( new InputsA05() );
        f.pack();
        f.setVisible( true );
    }
    ...
    public void setInputPinState ( HashMap<InputPinA05, Boolean> inputPinState ) {
    ...
    public static class InputPinBean {
        ...
        private InputPinA05 usl;
        private InputPinA05 lsl;
        private InputPinA05 udz;
        private InputPinA05 ldz;
        private InputPinA05 ins;
        private InputPinA05 insUp;
        private InputPinA05 insDown;
        private InputPinA05 drvOK;
        private InputPinA05 drvBM;
        private InputPinA05 drvENF;
        private InputPinA05 enable;
        private InputPinA05 dbde;
        private InputPinA05 dbdf;
        private InputPinA05 bs1;
        private InputPinA05 bs2;
        private InputPinA05 dfc;
        private InputPinA05 dw;
        private InputPinA05 hes;
        private InputPinA05 ces;
        private InputPinA05 lvcfb;
        private InputPinA05 thm;
        private InputPinA05 encf;
        private InputPinA05 url;
        private InputPinA05 lrl;
        private InputPinA05 epb;
        private InputPinA05 ucmts;
        private InputPinA05 ucmts2;
        private InputPinA05 ucmts3;
        ...
        public InputPinA05 getUsl () {
            return usl;
        }


        public InputPinA05 getLsl () {
            return lsl;
        }


        public InputPinA05 getUdz () {
            return udz;
        }


        public InputPinA05 getLdz () {
            return ldz;
        }


        public InputPinA05 getIns () {
            return ins;
        }


        public InputPinA05 getInsUp () {
            return insUp;
        }


        public InputPinA05 getInsDown () {
            return insDown;
        }


        public InputPinA05 getDrvOK () {
            return drvOK;
        }


        public InputPinA05 getDrvBM () {
            return drvBM;
        }


        public InputPinA05 getDrvENF () {
            return drvENF;
        }


        public InputPinA05 getEnable () {
            return enable;
        }


        public InputPinA05 getDbde () {
            return dbde;
        }


        public InputPinA05 getDbdf () {
            return dbdf;
        }


        public InputPinA05 getBs1 () {
            return bs1;
        }
        public InputPinA05 getBs2 () {
            return bs2;
        }

        public InputPinA05 getDfc () {
            return dfc;
        }


        public InputPinA05 getDw () {
            return dw;
        }


        public InputPinA05 getHes () {
            return hes;
        }


        public InputPinA05 getCes () {
            return ces;
        }


        public InputPinA05 getLvcfb () {
            return lvcfb;
        }


        public InputPinA05 getThm () {
            return thm;
        }


        public InputPinA05 getEncf () {
            return encf;
        }


        public final InputPinA05 getUrl() {
            return url;
        }


        public final InputPinA05 getLrl() {
            return lrl;
        }
        public InputPinA05 getEpb() {
			return epb;
		}

		public InputPinA05 getUcmts() {
			return ucmts;
		}

		public InputPinA05 getUcmts2() {
			return ucmts2;
		}
		public InputPinA05 getUcmts3() {
			return ucmts3;
		}
        public void setUsl ( InputPinA05 usl ) {
            this.usl = usl;
        }


        public void setLsl ( InputPinA05 lsl ) {
            this.lsl = lsl;
        }


        public void setUdz ( InputPinA05 udz ) {
            this.udz = udz;
        }


        public void setLdz ( InputPinA05 ldz ) {
            this.ldz = ldz;
        }


        public void setIns ( InputPinA05 ins ) {
            this.ins = ins;
        }


        public void setInsUp ( InputPinA05 insUp ) {
            this.insUp = insUp;
        }


        public void setInsDown ( InputPinA05 insDown ) {
            this.insDown = insDown;
        }


        public void setDrvOK ( InputPinA05 drvOK ) {
            this.drvOK = drvOK;
        }


        public void setDrvBM ( InputPinA05 drvBM ) {
            this.drvBM = drvBM;
        }


        public void setDrvENF ( InputPinA05 drvENF ) {
            this.drvENF = drvENF;
        }


        public void setEnable ( InputPinA05 enable ) {
            this.enable = enable;
        }


        public void setDbde ( InputPinA05 dbde ) {
            this.dbde = dbde;
        }


        public void setDbdf ( InputPinA05 dbdf ) {
            this.dbdf = dbdf;
        }


        public void setBs1 ( InputPinA05 bs ) {
            this.bs1 = bs;
        }
        public void setBs2 ( InputPinA05 bs ) {
            this.bs2 = bs;
        }

        public void setDfc ( InputPinA05 dfc ) {
            this.dfc = dfc;
        }


        public void setDw ( InputPinA05 dw ) {
            this.dw = dw;
        }


        public void setHes ( InputPinA05 hes ) {
            this.hes = hes;
        }


        public void setCes ( InputPinA05 ces ) {
            this.ces = ces;
        }


        public void setLvcfb ( InputPinA05 lvcfb ) {
            this.lvcfb = lvcfb;
        }


        public void setThm ( InputPinA05 thm ) {
            this.thm = thm;
        }


        public void setEncf ( InputPinA05 encf ) {
            this.encf = encf;
        }


        public final void setUrl(InputPinA05 url) {
            this.url = url;
        }


        public final void setLrl(InputPinA05 lrl) {
            this.lrl = lrl;
        }
        public void setEpb(InputPinA05 epb) {
			this.epb = epb;
		}
		public void setUcmts(InputPinA05 ucmts) {
			this.ucmts = ucmts;
		}
		public void setUcmts2(InputPinA05 ucmts2) {
			this.ucmts2 = ucmts2;
		}
		public void setUcmts3(InputPinA05 ucmts3) {
			this.ucmts3 = ucmts3;
		}
    }
    ...
    public class ItemChangedListener implements ActionListener, ItemListener {
        public void itemStateChanged ( ItemEvent e ) {
            if ( settingPanel instanceof InputsA05Setting ) {
                ( ( InputsA05Setting )settingPanel ).updateStatus();
            }
        }

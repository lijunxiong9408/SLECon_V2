...
public class InputsA03 extends JPanel {
    private static final long      serialVersionUID = 6592660277537767456L;
    
    private static final ResourceBundle TEXT             = ToolBox.getResourceBundle( "setting.io.InputsA03" );
    ...
    private SettingPanel<InputsA03> settingPanel;
    ...
    private HashMap<InputPinA03, Boolean> inputPinState;
    ...
    public void setSettingPanel ( SettingPanel<InputsA03> panel ) {
    ...
    private void initGUI () {
        ...
        cbo_line_insdown.setModel( new DefaultComboBoxModel<>( InputPinA03.allDisplayItem() ) );
        ...
        cbo_line_drvok.setModel( new DefaultComboBoxModel<>( InputPinA03.allDisplayItem() ) );
        chk_line_drvok   = new MyCheckBox();
        state_line_drvok = new JLabel( GRAY_ICON );
        lbl_line_drvbm   = new JLabel();
        cbo_line_drvbm   = new MyComboBox();
        cbo_line_drvbm.setModel( new DefaultComboBoxModel<>( InputPinA03.allDisplayItem() ) );
        ...
        cbo_line_drvenf.setModel( new DefaultComboBoxModel<>( InputPinA03.allDisplayItem() ) );
        ...
        cbo_line_ucmts2.setModel( new DefaultComboBoxModel<>( InputPinA03.allDisplayItem() ) );
        ...
        cbo_line_ucmts3.setModel( new DefaultComboBoxModel<>( InputPinA03.allDisplayItem() ) );
    ...
    public InputPinBean getInputPinBean () throws ConvertException {
        ...
        bean_inputPin.setUsl( ( InputPinA03 )cbo_line_usl.getSelectedItem() );
        bean_inputPin.setLsl( ( InputPinA03 )cbo_line_lsl.getSelectedItem() );
        bean_inputPin.setUdz( ( InputPinA03 )cbo_line_udz.getSelectedItem() );
        bean_inputPin.setLdz( ( InputPinA03 )cbo_line_ldz.getSelectedItem() );
        bean_inputPin.setIns( ( InputPinA03 )cbo_line_ins.getSelectedItem() );
        bean_inputPin.setInsUp( ( InputPinA03 )cbo_line_insup.getSelectedItem() );
        bean_inputPin.setInsDown( ( InputPinA03 )cbo_line_insdown.getSelectedItem() );
        bean_inputPin.setDrvOK( ( InputPinA03 )cbo_line_drvok.getSelectedItem() );
        bean_inputPin.setDrvBM( ( InputPinA03 )cbo_line_drvbm.getSelectedItem() );
        bean_inputPin.setDrvENF( ( InputPinA03 )cbo_line_drvenf.getSelectedItem() );
        bean_inputPin.setEnable( ( InputPinA03 )cbo_line_enable.getSelectedItem() );
        bean_inputPin.setDbde( ( InputPinA03 )cbo_line_dbde.getSelectedItem() );
        bean_inputPin.setDbdf( ( InputPinA03 )cbo_line_dbdf.getSelectedItem() );
        bean_inputPin.setBs1( ( InputPinA03 )cbo_line_bs1.getSelectedItem() );
        bean_inputPin.setBs2( ( InputPinA03 )cbo_line_bs2.getSelectedItem() );
        bean_inputPin.setDfc( ( InputPinA03 )cbo_line_dfc.getSelectedItem() );
        bean_inputPin.setDw( ( InputPinA03 )cbo_line_dw.getSelectedItem() );
        bean_inputPin.setHes( ( InputPinA03 )cbo_line_hes.getSelectedItem() );
        bean_inputPin.setCes( ( InputPinA03 )cbo_line_ces.getSelectedItem() );
        bean_inputPin.setLvcfb( ( InputPinA03 )cbo_line_lvcfb.getSelectedItem() );
        bean_inputPin.setThm( ( InputPinA03 )cbo_line_thm.getSelectedItem() );
        bean_inputPin.setEncf( ( InputPinA03 )cbo_line_encf.getSelectedItem() );
        bean_inputPin.setUrl( ( InputPinA03 )cbo_line_url.getSelectedItem() );
        bean_inputPin.setLrl( ( InputPinA03 )cbo_line_lrl.getSelectedItem() );
        bean_inputPin.setEpb( ( InputPinA03 )cbo_line_epb.getSelectedItem() );
        bean_inputPin.setUcmts( ( InputPinA03 )cbo_line_ucmts.getSelectedItem() );
        bean_inputPin.setUcmts2( ( InputPinA03 )cbo_line_ucmts2.getSelectedItem() );
        bean_inputPin.setUcmts3( ( InputPinA03 )cbo_line_ucmts3.getSelectedItem() );
    ...
    public void setInputPinBean ( InputPinBean bean_inputPin ) {
        final InputPinA03[] items = InputPinA03.allDisplayItem(bean_inputPin.firmwareVersion);
        ...
        List<InputPinA03> list = Arrays.asList( items );
    ...
    public static InputsA03 createPanel ( SettingPanel<InputsA03> panel ) {
        InputsA03 gui = new InputsA03();
    ...
    public static void main ( String... arg ) {
        ...
        f.getContentPane().add( new InputsA03() );
        f.pack();
        f.setVisible( true );
    }
    ...
    public void setInputPinState ( HashMap<InputPinA03, Boolean> inputPinState ) {
    ...
    public static class InputPinBean {
        ...
        private InputPinA03 usl;
        private InputPinA03 lsl;
        private InputPinA03 udz;
        private InputPinA03 ldz;
        private InputPinA03 ins;
        private InputPinA03 insUp;
        private InputPinA03 insDown;
        private InputPinA03 drvOK;
        private InputPinA03 drvBM;
        private InputPinA03 drvENF;
        private InputPinA03 enable;
        private InputPinA03 dbde;
        private InputPinA03 dbdf;
        private InputPinA03 bs1;
        private InputPinA03 bs2;
        private InputPinA03 dfc;
        private InputPinA03 dw;
        private InputPinA03 hes;
        private InputPinA03 ces;
        private InputPinA03 lvcfb;
        private InputPinA03 thm;
        private InputPinA03 encf;
        private InputPinA03 url;
        private InputPinA03 lrl;
        private InputPinA03 epb;
        private InputPinA03 ucmts;
        private InputPinA03 ucmts2;
        private InputPinA03 ucmts3;
        ...
        public InputPinA03 getUsl () {
            return usl;
        }


        public InputPinA03 getLsl () {
            return lsl;
        }


        public InputPinA03 getUdz () {
            return udz;
        }


        public InputPinA03 getLdz () {
            return ldz;
        }


        public InputPinA03 getIns () {
            return ins;
        }


        public InputPinA03 getInsUp () {
            return insUp;
        }


        public InputPinA03 getInsDown () {
            return insDown;
        }


        public InputPinA03 getDrvOK () {
            return drvOK;
        }


        public InputPinA03 getDrvBM () {
            return drvBM;
        }


        public InputPinA03 getDrvENF () {
            return drvENF;
        }


        public InputPinA03 getEnable () {
            return enable;
        }


        public InputPinA03 getDbde () {
            return dbde;
        }


        public InputPinA03 getDbdf () {
            return dbdf;
        }


        public InputPinA03 getBs1 () {
            return bs1;
        }
        public InputPinA03 getBs2 () {
            return bs2;
        }
        
        public InputPinA03 getDfc () {
            return dfc;
        }


        public InputPinA03 getDw () {
            return dw;
        }


        public InputPinA03 getHes () {
            return hes;
        }


        public InputPinA03 getCes () {
            return ces;
        }


        public InputPinA03 getLvcfb () {
            return lvcfb;
        }


        public InputPinA03 getThm () {
            return thm;
        }


        public InputPinA03 getEncf () {
            return encf;
        }


        public final InputPinA03 getUrl() {
            return url;
        }


        public final InputPinA03 getLrl() {
            return lrl;
        }
        
        public InputPinA03 getEpb() {
			return epb;
		}
        

		public InputPinA03 getUcmts() {
			return ucmts;
		}


		public InputPinA03 getUcmts2() {
			return ucmts2;
		}


		public InputPinA03 getUcmts3() {
			return ucmts3;
		}

        public void setUsl ( InputPinA03 usl ) {
            this.usl = usl;
        }


        public void setLsl ( InputPinA03 lsl ) {
            this.lsl = lsl;
        }


        public void setUdz ( InputPinA03 udz ) {
            this.udz = udz;
        }


        public void setLdz ( InputPinA03 ldz ) {
            this.ldz = ldz;
        }


        public void setIns ( InputPinA03 ins ) {
            this.ins = ins;
        }


        public void setInsUp ( InputPinA03 insUp ) {
            this.insUp = insUp;
        }


        public void setInsDown ( InputPinA03 insDown ) {
            this.insDown = insDown;
        }


        public void setDrvOK ( InputPinA03 drvOK ) {
            this.drvOK = drvOK;
        }


        public void setDrvBM ( InputPinA03 drvBM ) {
            this.drvBM = drvBM;
        }


        public void setDrvENF ( InputPinA03 drvENF ) {
            this.drvENF = drvENF;
        }


        public void setEnable ( InputPinA03 enable ) {
            this.enable = enable;
        }


        public void setDbde ( InputPinA03 dbde ) {
            this.dbde = dbde;
        }


        public void setDbdf ( InputPinA03 dbdf ) {
            this.dbdf = dbdf;
        }


        public void setBs1 ( InputPinA03 bs ) {
            this.bs1 = bs;
        }
        public void setBs2 ( InputPinA03 bs ) {
            this.bs2 = bs;
        }

        public void setDfc ( InputPinA03 dfc ) {
            this.dfc = dfc;
        }


        public void setDw ( InputPinA03 dw ) {
            this.dw = dw;
        }


        public void setHes ( InputPinA03 hes ) {
            this.hes = hes;
        }


        public void setCes ( InputPinA03 ces ) {
            this.ces = ces;
        }


        public void setLvcfb ( InputPinA03 lvcfb ) {
            this.lvcfb = lvcfb;
        }


        public void setThm ( InputPinA03 thm ) {
            this.thm = thm;
        }


        public void setEncf ( InputPinA03 encf ) {
            this.encf = encf;
        }


        public final void setUrl(InputPinA03 url) {
            this.url = url;
        }


        public final void setLrl(InputPinA03 lrl) {
            this.lrl = lrl;
        }
        
        public void setEpb(InputPinA03 epb) {
			this.epb = epb;
		}

		public void setUcmts(InputPinA03 ucmts) {
			this.ucmts = ucmts;
		}

		public void setUcmts2(InputPinA03 ucmts2) {
			this.ucmts2 = ucmts2;
		}

		public void setUcmts3(InputPinA03 ucmts3) {
			this.ucmts3 = ucmts3;
		}
    }
    ...
    public class ItemChangedListener implements ActionListener, ItemListener {
        public void itemStateChanged ( ItemEvent e ) {
            if ( settingPanel instanceof InputsA03Setting ) {
                ( ( InputsA03Setting )settingPanel ).updateStatus();
            }
        }

...
public class InputsC01 extends JPanel {
    private static final long      serialVersionUID = 6592660277537767456L;
    
    private static final ResourceBundle TEXT             = ToolBox.getResourceBundle( "setting.io.InputsC01" );
    ...
    private SettingPanel<InputsC01> settingPanel;
    ...
    public void setSettingPanel ( SettingPanel<InputsC01> panel ) {
    ...
    private void initGUI () {
        ...
        cbo_line_insdown.setModel( new DefaultComboBoxModel<>( InputPinC01.allDisplayItem() ) );
        ...
        cbo_line_drvok.setModel( new DefaultComboBoxModel<>( InputPinC01.allDisplayItem() ) );
        chk_line_drvok   = new MyCheckBox();
        state_line_drvok = new JLabel( GRAY_ICON );
        lbl_line_drvbm   = new JLabel();
        cbo_line_drvbm   = new MyComboBox();
        cbo_line_drvbm.setModel( new DefaultComboBoxModel<>( InputPinC01.allDisplayItem() ) );
        ...
        cbo_line_drvenf.setModel( new DefaultComboBoxModel<>( InputPinC01.allDisplayItem() ) );
        ...
        cbo_line_ucmts2.setModel( new DefaultComboBoxModel<>( InputPinC01.allDisplayItem() ) );
    ...
    public InputPinBean getInputPinBean () throws ConvertException {
        ...
        bean_inputPin.setUsl( ( InputPinC01 )cbo_line_usl.getSelectedItem() );
        bean_inputPin.setLsl( ( InputPinC01 )cbo_line_lsl.getSelectedItem() );
        bean_inputPin.setUdz( ( InputPinC01 )cbo_line_udz.getSelectedItem() );
        bean_inputPin.setLdz( ( InputPinC01 )cbo_line_ldz.getSelectedItem() );
        bean_inputPin.setIns( ( InputPinC01 )cbo_line_ins.getSelectedItem() );
        bean_inputPin.setInsUp( ( InputPinC01 )cbo_line_insup.getSelectedItem() );
        bean_inputPin.setInsDown( ( InputPinC01 )cbo_line_insdown.getSelectedItem() );
        bean_inputPin.setDrvOK( ( InputPinC01 )cbo_line_drvok.getSelectedItem() );
        bean_inputPin.setDrvBM( ( InputPinC01 )cbo_line_drvbm.getSelectedItem() );
        bean_inputPin.setDrvENF( ( InputPinC01 )cbo_line_drvenf.getSelectedItem() );
        bean_inputPin.setEnable( ( InputPinC01 )cbo_line_enable.getSelectedItem() );
        bean_inputPin.setDbde( ( InputPinC01 )cbo_line_dbde.getSelectedItem() );
        bean_inputPin.setDbdf( ( InputPinC01 )cbo_line_dbdf.getSelectedItem() );
        bean_inputPin.setBs1( ( InputPinC01 )cbo_line_bs1.getSelectedItem() );
        bean_inputPin.setBs2( ( InputPinC01 )cbo_line_bs2.getSelectedItem() );
        bean_inputPin.setDfc( ( InputPinC01 )cbo_line_dfc.getSelectedItem() );
        bean_inputPin.setDw( ( InputPinC01 )cbo_line_dw.getSelectedItem() );
        bean_inputPin.setHes( ( InputPinC01 )cbo_line_hes.getSelectedItem() );
        bean_inputPin.setCes( ( InputPinC01 )cbo_line_ces.getSelectedItem() );
        bean_inputPin.setLvcfb( ( InputPinC01 )cbo_line_lvcfb.getSelectedItem() );
        bean_inputPin.setThm( ( InputPinC01 )cbo_line_thm.getSelectedItem() );
        bean_inputPin.setEncf( ( InputPinC01 )cbo_line_encf.getSelectedItem() );
        bean_inputPin.setUrl( ( InputPinC01 )cbo_line_url.getSelectedItem() );
        bean_inputPin.setLrl( ( InputPinC01 )cbo_line_lrl.getSelectedItem() );
        bean_inputPin.setEpb( ( InputPinC01 )cbo_line_epb.getSelectedItem() );
    ...
    public void setInputPinBean ( InputPinBean bean_inputPin ) {
        final InputPinC01[] items = InputPinC01.allDisplayItem(bean_inputPin.firmwareVersion);
    ...
    public static InputsC01 createPanel ( SettingPanel<InputsC01> panel ) {
        InputsC01 gui = new InputsC01();
    ...
    public static void main ( String... arg ) {
        ...
        f.getContentPane().add( new InputsC01() );
        f.pack();
        f.setVisible( true );
    }
    ...
    public void setInputPinState ( HashMap<InputPinC01, Boolean> inputPinState ) {
    ...
    public static class InputPinBean {
        ...
        private InputPinC01 usl;
        private InputPinC01 lsl;
        private InputPinC01 udz;
        private InputPinC01 ldz;
        private InputPinC01 ins;
        private InputPinC01 insUp;
        private InputPinC01 insDown;
        private InputPinC01 drvOK;
        private InputPinC01 drvBM;
        private InputPinC01 drvENF;
        private InputPinC01 enable;
        private InputPinC01 dbde;
        private InputPinC01 dbdf;
        private InputPinC01 bs1;
        private InputPinC01 bs2;
        private InputPinC01 dfc;
        private InputPinC01 dw;
        private InputPinC01 hes;
        private InputPinC01 ces;
        private InputPinC01 lvcfb;
        private InputPinC01 thm;
        private InputPinC01 encf;
        private InputPinC01 url;
        private InputPinC01 lrl;
        private InputPinC01 epb;
		...
		public InputPinC01 getUsl () {
            return usl;
        }


        public InputPinC01 getLsl () {
            return lsl;
        }


        public InputPinC01 getUdz () {
            return udz;
        }


        public InputPinC01 getLdz () {
            return ldz;
        }


        public InputPinC01 getIns () {
            return ins;
        }


        public InputPinC01 getInsUp () {
            return insUp;
        }


        public InputPinC01 getInsDown () {
            return insDown;
        }


        public InputPinC01 getDrvOK () {
            return drvOK;
        }


        public InputPinC01 getDrvBM () {
            return drvBM;
        }


        public InputPinC01 getDrvENF () {
            return drvENF;
        }


        public InputPinC01 getEnable () {
            return enable;
        }


        public InputPinC01 getDbde () {
            return dbde;
        }


        public InputPinC01 getDbdf () {
            return dbdf;
        }


        public InputPinC01 getBs1 () {
            return bs1;
        }
        
        public InputPinC01 getBs2 () {
            return bs2;
        }

        public InputPinC01 getDfc () {
            return dfc;
        }


        public InputPinC01 getDw () {
            return dw;
        }


        public InputPinC01 getHes () {
            return hes;
        }


        public InputPinC01 getCes () {
            return ces;
        }


        public InputPinC01 getLvcfb () {
            return lvcfb;
        }


        public InputPinC01 getThm () {
            return thm;
        }


        public InputPinC01 getEncf () {
            return encf;
        }


        public final InputPinC01 getUrl() {
            return url;
        }


        public final InputPinC01 getLrl() {
            return lrl;
        }
        
        
        public InputPinC01 getEpb() {
			return epb;
		}
        

		public InputPinC01 getUcmts() {
			return ucmts;
		}


		public InputPinC01 getUcmts2() {
			return ucmts2;
		}


		public InputPinC01 getUcmts3() {
			return ucmts3;
		}
        ...
        public void setLsl ( InputPinC01 lsl ) {
            this.lsl = lsl;
        }


        public void setUdz ( InputPinC01 udz ) {
            this.udz = udz;
        }


        public void setLdz ( InputPinC01 ldz ) {
            this.ldz = ldz;
        }


        public void setIns ( InputPinC01 ins ) {
            this.ins = ins;
        }


        public void setInsUp ( InputPinC01 insUp ) {
            this.insUp = insUp;
        }


        public void setInsDown ( InputPinC01 insDown ) {
            this.insDown = insDown;
        }


        public void setDrvOK ( InputPinC01 drvOK ) {
            this.drvOK = drvOK;
        }


        public void setDrvBM ( InputPinC01 drvBM ) {
            this.drvBM = drvBM;
        }


        public void setDrvENF ( InputPinC01 drvENF ) {
            this.drvENF = drvENF;
        }


        public void setEnable ( InputPinC01 enable ) {
            this.enable = enable;
        }


        public void setDbde ( InputPinC01 dbde ) {
            this.dbde = dbde;
        }


        public void setDbdf ( InputPinC01 dbdf ) {
            this.dbdf = dbdf;
        }


        public void setBs1 ( InputPinC01 bs ) {
            this.bs1 = bs;
        }
        
        public void setBs2 ( InputPinC01 bs ) {
            this.bs2 = bs;
        }

        public void setDfc ( InputPinC01 dfc ) {
            this.dfc = dfc;
        }


        public void setDw ( InputPinC01 dw ) {
            this.dw = dw;
        }


        public void setHes ( InputPinC01 hes ) {
            this.hes = hes;
        }


        public void setCes ( InputPinC01 ces ) {
            this.ces = ces;
        }


        public void setLvcfb ( InputPinC01 lvcfb ) {
            this.lvcfb = lvcfb;
        }


        public void setThm ( InputPinC01 thm ) {
            this.thm = thm;
        }


        public void setEncf ( InputPinC01 encf ) {
            this.encf = encf;
        }


        public final void setUrl(InputPinC01 url) {
            this.url = url;
        }


        public final void setLrl(InputPinC01 lrl) {
            this.lrl = lrl;
        }


		public void setEpb(InputPinC01 epb) {
			this.epb = epb;
		}

		public void setUcmts(InputPinC01 ucmts) {
			this.ucmts = ucmts;
		}

		public void setUcmts2(InputPinC01 ucmts2) {
			this.ucmts2 = ucmts2;
		}
    ...
    public class ItemChangedListener implements ActionListener, ItemListener {
        public void itemStateChanged ( ItemEvent e ) {
            if ( settingPanel instanceof InputsC01Setting ) {
                ( ( InputsC01Setting )settingPanel ).updateStatus();
            }
        }

...
@SetupView(
    ...
    sortIndex = 0x231,
    condition = "lift.version.mcsBoardVersion=='C01'"
)
public class InputsC01Setting extends SettingPanel<InputsC01> implements Page, LiftDataChangedListener {
     ...
     * Logger.
     */
    private final Logger logger = LogManager.getLogger(InputsC01Setting.class);
    ...
    public InputsC01Setting ( LiftConnectionBean connBean ) {
        super(connBean);
    ...
    @Override
    public void onOK(InputsC01 panel) {
		synchronized ( mutex  ) {
		     setEnabled(false);
		     if(submit())
		    	 solid = null;
    ...
    @Override
    public void onReset(InputsC01 panel) {
    ...
    private static final class Solid {
        private InputsC01.InputPinBean bean;

        private Solid(InputsC01.InputPinBean bean) {
            super();
            this.bean = bean;
        }
    }
    ...
    public void setHot() {
        ...
        try {
            final InputsC01.InputPinBean bean = new InputsC01.InputPinBean();
            ...
            bean.setFirmwareVersion(mcsconfig.getFirmwareVersion());
            {
                ...
                int code = raw & 0x7f;
                bean.setUsl(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLsl(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUdz(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLdz(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setIns(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setInsUp(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setInsDown(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvOK(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvBM(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvENF(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEnable(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDbde(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDbdf(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setBs1(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setBs2(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDfc(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDw(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setHes(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setCes(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLvcfb(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setThm(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEncf(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUrl(InputPinC01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLrl(InputPinC01.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEpb(InputPinC01.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts(InputPinC01.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts2(InputPinC01.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts3(InputPinC01.getByRawIOPosition(code));
    ...
    public boolean submit() {
    	if(IsVerify) {
    		try {
	            InputsC01.InputPinBean bean = app.getInputPinBean();
    ...
    public void updateStatus () {
        final HashMap<InputPinC01, Boolean> result   = new HashMap<>();
        CrossBar                            crossbar = new CrossBar( mcsconfig.getCrossbar() );
        byte[]                              rawIO    = status.getMcsIO();
        for ( InputPinC01 pin : InputPinC01.values() ) {

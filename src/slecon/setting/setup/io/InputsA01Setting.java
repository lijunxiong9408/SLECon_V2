...
@SetupView(
    ...
    sortIndex = 0x231,
    condition = "lift.version.mcsBoardVersion=='A01'"
)
public class InputsA01Setting extends SettingPanel<InputsA01> implements Page, LiftDataChangedListener {
     ...
     * Logger.
     */
    private final Logger logger = LogManager.getLogger(InputsA01Setting.class);
    ...
    public InputsA01Setting ( LiftConnectionBean connBean ) {
        super(connBean);
    ...
    @Override
    public void onOK(InputsA01 panel) {
		synchronized ( mutex  ) {
		     setEnabled(false);
		     if(submit())
		    	 solid = null;
    ...
    @Override
    public void onReset(InputsA01 panel) {
    ...
    private static final class Solid {
        private InputsA01.InputPinBean bean;

        private Solid(InputsA01.InputPinBean bean) {
            super();
            this.bean = bean;
        }
    }
    ...
    public void setHot() {
        ...
        try {
            final InputsA01.InputPinBean bean = new InputsA01.InputPinBean();
            ...
            bean.setFirmwareVersion(mcsconfig.getFirmwareVersion());
            {
                ...
                int code = raw & 0x7f;
                bean.setUsl(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLsl(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUdz(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLdz(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setIns(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setInsUp(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setInsDown(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvOK(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvBM(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEnable(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDbdf(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setBs1(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setBs2(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setSt1(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setSt2(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setSt3(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setSt4(InputPinA01.getByRawIOPosition(code));
                bean.setSt4Inverted(isInverted);
            }
            /*
            {
                // ST5
                int raw = nvram.getUnsignedByte(NVAddress.NVADDR_0.address).intValue();
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setSt5(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setSt6(InputPinA01.getByRawIOPosition(code));
            ...
            */
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLvcfb(InputPinA01.getByRawIOPosition(code));
            ...
            /*
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLvc1fb(InputPinA01.getByRawIOPosition(code));
            ...
            */
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setThm(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEncf(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUrl(InputPinA01.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLrl(InputPinA01.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEpb(InputPinA01.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts(InputPinA01.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts2(InputPinA01.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts3(InputPinA01.getByRawIOPosition(code));
            ...
            /*
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDlb(InputPinA01.getByRawIOPosition(code));
    ...
    public boolean submit() {
    	if(IsVerify) {
    		try {
	            InputsA01.InputPinBean bean = app.getInputPinBean();
	            ...
	            nvram.setByte( NVAddress.NVADDR_IN_CES_BITPOS.address, (byte) (bean.isSt1Inverted() ? ((int) bean.getSt1().rawIOPos)+128 : bean.getSt1().rawIOPos));
	            nvram.setByte( NVAddress.NVADDR_IN_HES_BITPOS.address, (byte) (bean.isSt2Inverted() ? ((int) bean.getSt2().rawIOPos)+128 : bean.getSt2().rawIOPos));
	            nvram.setByte( NVAddress.NVADDR_IN_DW_BITPOS.address, (byte) (bean.isSt3Inverted() ? ((int) bean.getSt3().rawIOPos)+128 : bean.getSt3().rawIOPos));
	            nvram.setByte( NVAddress.NVADDR_IN_DFC_BITPOS.address, (byte) (bean.isSt4Inverted() ? ((int) bean.getSt4().rawIOPos)+128 : bean.getSt4().rawIOPos));
	            nvram.setByte( NVAddress.NVADDR_0.address, (byte) (bean.isSt5Inverted() ? ((int) bean.getSt5().rawIOPos)+128 : bean.getSt5().rawIOPos));
	            nvram.setByte( NVAddress.NVADDR_0.address, (byte) (bean.isSt6Inverted() ? ((int) bean.getSt6().rawIOPos)+128 : bean.getSt6().rawIOPos));
	            ...
	            nvram.setByte( NVAddress.NVADDR_0.address, (byte) (bean.isLvc1fbInverted() ? ((int) bean.getLvc1fb().rawIOPos)+128 : bean.getLvc1fb().rawIOPos));
	            ...
	            nvram.setByte( NVAddress.NVADDR_0.address, (byte) (bean.isDlbInverted() ? ((int) bean.getDlb().rawIOPos)+128 : bean.getDlb().rawIOPos));
	            nvram.setByte( NVAddress.NVADDR_0.address, (byte) (bean.isDi1Inverted() ? ((int) bean.getDi1().rawIOPos)+128 : bean.getDi1().rawIOPos));
	            nvram.setByte( NVAddress.NVADDR_0.address, (byte) (bean.isDi2Inverted() ? ((int) bean.getDi2().rawIOPos)+128 : bean.getDi2().rawIOPos));
	            nvram.setByte( NVAddress.NVADDR_0.address, (byte) (bean.isDi3Inverted() ? ((int) bean.getDi3().rawIOPos)+128 : bean.getDi3().rawIOPos));
	            nvram.setByte( NVAddress.NVADDR_0.address, (byte) (bean.isDi4Inverted() ? ((int) bean.getDi4().rawIOPos)+128 : bean.getDi4().rawIOPos));
    ...
    public void updateStatus () {
        final HashMap<InputPinA01, Boolean> result   = new HashMap<>();
        CrossBar                            crossbar = new CrossBar( mcsconfig.getCrossbar() );
        byte[]                              rawIO    = status.getMcsIO();
        for ( InputPinA01 pin : InputPinA01.values() ) {

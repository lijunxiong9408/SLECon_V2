...
@SetupView(
    ...
    sortIndex = 0x231,
    condition = "lift.version.mcsBoardVersion=='A07'"
)
public class InputsA07Setting extends SettingPanel<InputsA07> implements Page, LiftDataChangedListener {
     ...
     * Logger.
     */
    private final Logger logger = LogManager.getLogger(InputsA07Setting.class);
    ...
    public InputsA07Setting ( LiftConnectionBean connBean ) {
        super(connBean);
    ...
    @Override
    public void onOK(InputsA07 panel) {
        synchronized ( mutex  ) {
            setEnabled(false);
            if ( submit() )
                solid = null;
    ...
    @Override
    public void onReset(InputsA07 panel) {
		 synchronized ( mutex  ) {
		     setEnabled(false);
		     reset();
		     setEnabled(true);
	...
	protected LinkedHashMap<String, Class<? extends JPanel>> getNavigation() {
		...
		map.put(Dict.lookup("I/O"), slecon.setting.setup.io.InputsA07Setting.class);
    ...
    private static final class Solid {
        private InputsA07.InputPinBean bean;

        private Solid(InputsA07.InputPinBean bean) {
            super();
            this.bean = bean;
        }
    }
    ...
    public void setHot() {
        ...
        try {
            final InputsA07.InputPinBean bean = new InputsA07.InputPinBean();
            ...
            bean.setFirmwareVersion(mcsconfig.getFirmwareVersion());
            {
                ...
                int code = raw & 0x7f;
                bean.setUsl(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLsl(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUdz(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLdz(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setIns(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setInsUp(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setInsDown(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvOK(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvBM(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDrvENF(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEnable(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDbde(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDbdf(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setBs1(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setBs2(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDfc(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setDw(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setHes(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setCes(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLvcfb(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setThm(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEncf(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUrl(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setLrl(InputPinA07.getByRawIOPosition(code));
            ...
            }
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setEpb(InputPinA07.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts(InputPinA07.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts2(InputPinA07.getByRawIOPosition(code));
            ...
            
            {
                ...
                boolean isInverted = raw > 0x7f;
                int code = raw & 0x7f;
                bean.setUcmts3(InputPinA07.getByRawIOPosition(code));
    ...
    public boolean submit() {
    	if(IsVerify) {
	        try {
	            InputsA07.InputPinBean bean = app.getInputPinBean();
    ...
    public void updateStatus () {
        final HashMap<InputPinA07, Boolean> result   = new HashMap<>();
        CrossBar                            crossbar = new CrossBar( mcsconfig.getCrossbar() );
        byte[]                              rawIO    = status.getMcsIO();
        for ( InputPinA07 pin : InputPinA07.values() ) {

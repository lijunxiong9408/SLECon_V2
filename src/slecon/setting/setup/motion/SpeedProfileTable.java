...
public class SpeedProfileTable extends JPanel {
    ...
    private String            tableTitle       = TEXT.getString( "Profile" );
    private String[]          hTitle           = {
    		tableTitle, "j1", "aamax", "j2", "vmax", "j3", "admax", "j4", "Open Loop"
    };
    private String[]          vTitle           = { TEXT.getString( "Normal" ), TEXT.getString( "Rescue" ),
                                                   TEXT.getString( "Correction" ), TEXT.getString( "Inspection" ),
                                                   TEXT.getString( "Force_Decel" ), TEXT.getString( "Re_Leveling" ) };
    private Class[] types = {
        String.class, Float.class, Float.class, Float.class, Float.class, Float.class, Float.class, Float.class, Long.class
    };
    ...
    public void setData ( Object[][] tableData ) {
        ...
        mainTable.setModel( new SpeedProfileTableModel( Data ) );
    ...
    private class SpeedProfileTableModel extends DefaultTableModel {
        Object data[][];

        public SpeedProfileTableModel ( Object[][] data ) {
            super( data, hTitle );
            this.data = data;
        }

...
public class DoorStatusA07 extends JPanel implements Page, LiftDataChangedListener {
    ...
    static HashMap<String, String>      styles                  = new HashMap<>();
    {
    	...
    	styles.put("labDoorSystem", "20 80 100 20 l");
    ...
    public DoorStatusA07 ( LiftConnectionBean bean) {
    	this.connBean = bean;
    ...
    public void setHot() {
        ...
        final InputSourceA07[] updateList = {InputSourceA07.DCS_FUDZ,InputSourceA07.DCS_FLDZ,InputSourceA07.DCS_RUDZ,
        					  InputSourceA07.DCS_RLDZ,InputSourceA07.DCS_NDZ,InputSourceA07.DCS_URL,InputSourceA07.DCS_LRL,
        					  InputSourceA07.DCS_INS,InputSourceA07.DCS_INS_UP,InputSourceA07.DCS_INS_DOWN,
        					  
        					  InputSourceA07.DCS_FR,InputSourceA07.DCS_LR,InputSourceA07.DCS_DCR,InputSourceA07.DCS_NDR,
        					  InputSourceA07.DCS_RDCR,InputSourceA07.DCS_RNDR
        					};
        
        for(InputSourceA07 obj : updateList) {
        ...
        final DoorStatusA07.DCSStatusBean dcsBean = new DoorStatusA07.DCSStatusBean();
        final DoorStatusA07.DoorBean      front   = new DoorStatusA07.DoorBean();
        final DoorStatusA07.DoorBean      rear    = new DoorStatusA07.DoorBean();
        final DoorStatusA07.LoadBean      load    = new DoorStatusA07.LoadBean();

        dcsBean.setFudz(map.get(InputSourceA07.DCS_FUDZ));
        dcsBean.setFldz(map.get(InputSourceA07.DCS_FLDZ));
        dcsBean.setRudz(map.get(InputSourceA07.DCS_RUDZ));
        dcsBean.setRldz(map.get(InputSourceA07.DCS_RLDZ));
        dcsBean.setNdz(map.get(InputSourceA07.DCS_NDZ));
        dcsBean.setUsl(map.get(InputSourceA07.DCS_URL));
        dcsBean.setLsl(map.get(InputSourceA07.DCS_LRL));
        dcsBean.setIns(map.get(InputSourceA07.DCS_INS));
        dcsBean.setInsup(map.get(InputSourceA07.DCS_INS_UP));
        dcsBean.setInsdown(map.get(InputSourceA07.DCS_INS_DOWN));
        // FAN and Light get state from DCS IO state, get invert.
        dcsBean.setFan( map.get(InputSourceA07.DCS_FR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setLight( map.get(InputSourceA07.DCS_LR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setDcr( map.get(InputSourceA07.DCS_DCR) );
        dcsBean.setNdr( map.get(InputSourceA07.DCS_NDR)  );
        ...
        front.setDcr(map.get(InputSourceA07.DCS_DCR));
        front.setNdr(map.get(InputSourceA07.DCS_NDR));
        ...
        rear.setDcr(map.get(InputSourceA07.DCS_RDCR));
        rear.setNdr(map.get(InputSourceA07.DCS_RNDR));

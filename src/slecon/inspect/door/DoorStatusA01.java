...
public class DoorStatusA01 extends JPanel implements Page, LiftDataChangedListener {
    ...
    public DoorStatusA01 ( LiftConnectionBean bean) {
    	this.connBean = bean;
    ...
    public void setHot() {
        ...
        final InputSourceA01[] updateList = {InputSourceA01.DCS_FUDZ,InputSourceA01.DCS_FLDZ,InputSourceA01.DCS_RUDZ,
        					  InputSourceA01.DCS_RLDZ,InputSourceA01.DCS_NDZ,InputSourceA01.DCS_URL,InputSourceA01.DCS_LRL,
        					  InputSourceA01.DCS_INS,InputSourceA01.DCS_INS_UP,InputSourceA01.DCS_INS_DOWN,
        					  
        					  InputSourceA01.DCS_FR,InputSourceA01.DCS_LR,InputSourceA01.DCS_DCR,InputSourceA01.DCS_NDR,
        					  InputSourceA01.DCS_RDCR,InputSourceA01.DCS_RNDR
        					};
        
        for(InputSourceA01 obj : updateList) {
        ...
        final DoorStatusA01.DCSStatusBean dcsBean = new DoorStatusA01.DCSStatusBean();
        final DoorStatusA01.DoorBean      front   = new DoorStatusA01.DoorBean();
        final DoorStatusA01.DoorBean      rear    = new DoorStatusA01.DoorBean();
        final DoorStatusA01.LoadBean      load    = new DoorStatusA01.LoadBean();
        
        dcsBean.setFudz(map.get(InputSourceA01.DCS_FUDZ));
        dcsBean.setFldz(map.get(InputSourceA01.DCS_FLDZ));
        dcsBean.setRudz(map.get(InputSourceA01.DCS_RUDZ));
        dcsBean.setRldz(map.get(InputSourceA01.DCS_RLDZ));
        dcsBean.setNdz(map.get(InputSourceA01.DCS_NDZ));
        dcsBean.setUrl(map.get(InputSourceA01.DCS_URL));
        dcsBean.setLrl(map.get(InputSourceA01.DCS_LRL));
        dcsBean.setIns(map.get(InputSourceA01.DCS_INS));
        dcsBean.setInsup(map.get(InputSourceA01.DCS_INS_UP));
        dcsBean.setInsdown(map.get(InputSourceA01.DCS_INS_DOWN));
        // FAN and Light get state from DCS IO state, get invert.
        dcsBean.setFan( map.get(InputSourceA01.DCS_FR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setLight( map.get(InputSourceA01.DCS_LR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setDcr( map.get(InputSourceA01.DCS_DCR) );
        dcsBean.setNdr( map.get(InputSourceA01.DCS_NDR)  );
        ...
        front.setDcr(map.get(InputSourceA01.DCS_DCR));
        front.setNdr(map.get(InputSourceA01.DCS_NDR));
        ...
        rear.setDcr(map.get(InputSourceA01.DCS_RDCR));
        rear.setNdr(map.get(InputSourceA01.DCS_RNDR));

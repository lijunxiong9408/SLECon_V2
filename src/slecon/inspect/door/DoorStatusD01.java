...
public class DoorStatusD01 extends JPanel implements Page, LiftDataChangedListener {
    ...
    private JLabel                      lblcIns;
    private JLabel                      lblcInsup;
    private JLabel                      lblcInsdown;
    ...
    public DoorStatusD01 ( LiftConnectionBean bean) {
    	this.connBean = bean;
    ...
    private void updateDCSStatus () {
        ...
        lblUrl.setIcon( onoffstatusToIcon( Type.INPUT, dcsStatusBean.getUrl() ) );
        lblLrl.setIcon( onoffstatusToIcon( Type.INPUT, dcsStatusBean.getLrl() ) );
        ...
        lblcIns.setIcon( onoffstatusToIcon( Type.INPUT, dcsStatusBean.getCins() ) );
        lblcInsup.setIcon( onoffstatusToIcon( Type.INPUT, dcsStatusBean.getCinsup() ) );
        lblcInsdown.setIcon( onoffstatusToIcon( Type.INPUT, dcsStatusBean.getCinsdown() ) );
    ...
    /*------------------------------------------------------------------------------------------------------------*/        
        ...
        panelDoorSystem = new JPanel(new MigLayout( "ins 20, w 640!, h 200!", "[110!]10[110!]10[110!]10[110!]10[110!]10[110!]", "[][]" ));
        ...
        panelDoorSystem.add( lblRUdz, "cell 0 1,growx,gapy 5" );
        ...
        panelDoorSystem.add( lblIns, "cell 1 1,growx,gapy 5" );
        ...
        lblcIns = new JLabel( "CINS" );
        lblcIns.setForeground(Color.WHITE);
        panelDoorSystem.add( lblcIns, "flowy,cell 2 1,growx,aligny top,gapy 5" );
        lblcInsup = new JLabel( "CINSUP" );
        lblcInsup.setForeground(Color.WHITE);
        panelDoorSystem.add( lblcInsup, "cell 2 1,growx,gapy 5" );
        lblcInsdown = new JLabel( "CINSDOWN" );
        lblcInsdown.setForeground(Color.WHITE);
        panelDoorSystem.add( lblcInsdown, "cell 2 1,growx,gapy 5" );
        lblFan = new JLabel( bundle.getString( "Fan" ) );
        lblFan.setForeground(Color.WHITE);
        panelDoorSystem.add( lblFan, "flowy,cell 3 1,growx,aligny top,gapy 5" );
        lblLight = new JLabel( bundle.getString( "Light" ) );
        lblLight.setForeground(Color.WHITE);
        panelDoorSystem.add( lblLight, "cell 3 1,growx,gapy 5" );
    ...
    public void setHot() {
        ...
        final InputSourceD01[] updateList = {InputSourceD01.DCS_FUDZ,InputSourceD01.DCS_FLDZ,InputSourceD01.DCS_RUDZ,
        					  InputSourceD01.DCS_RLDZ,InputSourceD01.DCS_NDZ,InputSourceD01.DCS_URL,InputSourceD01.DCS_DRL,
        					  InputSourceD01.DCS_INS,InputSourceD01.DCS_INS_UP,InputSourceD01.DCS_INS_DOWN,
        					  InputSourceD01.DCS_CINS,InputSourceD01.DCS_CINS_UP,InputSourceD01.DCS_CINS_DOWN,
        					  
        					  InputSourceD01.DCS_FR,InputSourceD01.DCS_LR,InputSourceD01.DCS_DCR,InputSourceD01.DCS_NDR,
        					  InputSourceD01.DCS_RDCR,InputSourceD01.DCS_RNDR
        					};
        
        for(InputSourceD01 obj : updateList) {
        ...
        final DoorStatusD01.DCSStatusBean dcsBean = new DoorStatusD01.DCSStatusBean();
        final DoorStatusD01.DoorBean      front   = new DoorStatusD01.DoorBean();
        final DoorStatusD01.DoorBean      rear    = new DoorStatusD01.DoorBean();
        final DoorStatusD01.LoadBean      load    = new DoorStatusD01.LoadBean();
        
        dcsBean.setFudz(map.get(InputSourceD01.DCS_FUDZ));
        dcsBean.setFldz(map.get(InputSourceD01.DCS_FLDZ));
        dcsBean.setRudz(map.get(InputSourceD01.DCS_RUDZ));
        dcsBean.setRldz(map.get(InputSourceD01.DCS_RLDZ));
        dcsBean.setNdz(map.get(InputSourceD01.DCS_NDZ));
        dcsBean.setUrl(map.get(InputSourceD01.DCS_URL));
        dcsBean.setLrl(map.get(InputSourceD01.DCS_DRL));
        dcsBean.setIns(map.get(InputSourceD01.DCS_INS));
        dcsBean.setInsup(map.get(InputSourceD01.DCS_INS_UP));
        dcsBean.setInsdown(map.get(InputSourceD01.DCS_INS_DOWN));
        dcsBean.setCins(map.get(InputSourceD01.DCS_CINS));
        dcsBean.setCinsup(map.get(InputSourceD01.DCS_CINS_UP));
        dcsBean.setCinsdown(map.get(InputSourceD01.DCS_CINS_DOWN));
        // FAN and Light get state from DCS IO state, get invert.
        dcsBean.setFan( map.get(InputSourceD01.DCS_FR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setLight( map.get(InputSourceD01.DCS_LR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setDcr( map.get(InputSourceD01.DCS_DCR) );
        dcsBean.setNdr( map.get(InputSourceD01.DCS_NDR)  );
        ...
        front.setDcr(map.get(InputSourceD01.DCS_DCR));
        front.setNdr(map.get(InputSourceD01.DCS_NDR));
        ...
        rear.setDcr(map.get(InputSourceD01.DCS_RDCR));
        rear.setNdr(map.get(InputSourceD01.DCS_RNDR));
    ...
    public static class DCSStatusBean {
        ...
        private OnOffStatus url     = OnOffStatus.DISABLED;
        private OnOffStatus lrl     = OnOffStatus.DISABLED;
        ...
        private OnOffStatus cins     = OnOffStatus.DISABLED;
        private OnOffStatus cinsup   = OnOffStatus.DISABLED;
        private OnOffStatus cinsdown = OnOffStatus.DISABLED;
        ...
        public DCSStatusBean ( OnOffStatus fudz, OnOffStatus fldz, OnOffStatus rudz, OnOffStatus rldz, OnOffStatus url, OnOffStatus lrl,
        					   OnOffStatus ndz, OnOffStatus ins, OnOffStatus insup, OnOffStatus insdown,
        					   OnOffStatus cins, OnOffStatus cinsup, OnOffStatus cinsdown, OnOffStatus fan, OnOffStatus light,
		...
		public OnOffStatus getUrl () {
            return url;
        }


        public OnOffStatus getLrl () {
            return lrl;
        }
        ...
        public void setUrl ( OnOffStatus url ) {
            this.url = url;
        }


        public void setLrl ( OnOffStatus lrl ) {
            this.lrl = lrl;
        }
        ...
        public OnOffStatus getCins() {
			return cins;
		}

		public void setCins(OnOffStatus cins) {
			this.cins = cins;
		}

		public OnOffStatus getCinsup() {
			return cinsup;
		}

		public void setCinsup(OnOffStatus cinsup) {
			this.cinsup = cinsup;
		}

		public OnOffStatus getCinsdown() {
			return cinsdown;
		}

		public void setCinsdown(OnOffStatus cinsdown) {
			this.cinsdown = cinsdown;
		}

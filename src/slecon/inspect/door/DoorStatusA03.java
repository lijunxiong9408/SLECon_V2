...
public class DoorStatusA03 extends JPanel implements Page, LiftDataChangedListener {
    ...
    public DoorStatusA03 ( LiftConnectionBean bean) {
    	this.connBean = bean;
    ...
    public void setHot() {
        ...
        final InputSourceA03[] updateList = {InputSourceA03.DCS_FUDZ,InputSourceA03.DCS_FLDZ,InputSourceA03.DCS_RUDZ,
        					  InputSourceA03.DCS_RLDZ,InputSourceA03.DCS_NDZ,InputSourceA03.DCS_URL,InputSourceA03.DCS_LRL,
        					  InputSourceA03.DCS_INS,InputSourceA03.DCS_INS_UP,InputSourceA03.DCS_INS_DOWN,
        					  
        					  InputSourceA03.DCS_FR,InputSourceA03.DCS_LR,InputSourceA03.DCS_DCR,InputSourceA03.DCS_NDR,
        					  InputSourceA03.DCS_RDCR,InputSourceA03.DCS_RNDR
        					};
        
        for(InputSourceA03 obj : updateList) {
        ...
        final DoorStatusA03.DCSStatusBean dcsBean = new DoorStatusA03.DCSStatusBean();
        final DoorStatusA03.DoorBean      front   = new DoorStatusA03.DoorBean();
        final DoorStatusA03.DoorBean      rear    = new DoorStatusA03.DoorBean();
        final DoorStatusA03.LoadBean      load    = new DoorStatusA03.LoadBean();

        dcsBean.setFudz(map.get(InputSourceA03.DCS_FUDZ));
        dcsBean.setFldz(map.get(InputSourceA03.DCS_FLDZ));
        dcsBean.setRudz(map.get(InputSourceA03.DCS_RUDZ));
        dcsBean.setRldz(map.get(InputSourceA03.DCS_RLDZ));
        dcsBean.setNdz(map.get(InputSourceA03.DCS_NDZ));
        dcsBean.setUsl(map.get(InputSourceA03.DCS_URL));
        dcsBean.setLsl(map.get(InputSourceA03.DCS_LRL));
        dcsBean.setIns(map.get(InputSourceA03.DCS_INS));
        dcsBean.setInsup(map.get(InputSourceA03.DCS_INS_UP));
        dcsBean.setInsdown(map.get(InputSourceA03.DCS_INS_DOWN));
        // FAN and Light get state from DCS IO state, get invert.
        dcsBean.setFan( map.get(InputSourceA03.DCS_FR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setLight( map.get(InputSourceA03.DCS_LR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setDcr( map.get(InputSourceA03.DCS_DCR) );
        dcsBean.setNdr( map.get(InputSourceA03.DCS_NDR)  );
        ...
        front.setDcr(map.get(InputSourceA03.DCS_DCR));
        front.setNdr(map.get(InputSourceA03.DCS_NDR));
        ...
        rear.setDcr(map.get(InputSourceA03.DCS_RDCR));
        rear.setNdr(map.get(InputSourceA03.DCS_RNDR));

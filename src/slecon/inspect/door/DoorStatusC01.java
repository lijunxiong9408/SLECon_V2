...
public class DoorStatusC01 extends JPanel implements Page, LiftDataChangedListener {
    ...
    public DoorStatusC01 ( LiftConnectionBean bean) {
    	this.connBean = bean;
    ...
    public void setHot() {
        ...
        final InputSourceC01[] updateList = {InputSourceC01.DCS_FUDZ,InputSourceC01.DCS_FLDZ,InputSourceC01.DCS_RUDZ,
        					  InputSourceC01.DCS_RLDZ,InputSourceC01.DCS_NDZ,InputSourceC01.DCS_URL,InputSourceC01.DCS_LRL,
        					  InputSourceC01.DCS_INS,InputSourceC01.DCS_INS_UP,InputSourceC01.DCS_INS_DOWN,
        					  
        					  InputSourceC01.DCS_FR,InputSourceC01.DCS_LR,InputSourceC01.DCS_DCR,InputSourceC01.DCS_NDR,
        					  InputSourceC01.DCS_RDCR,InputSourceC01.DCS_RNDR
        					};
        
        for(InputSourceC01 obj : updateList) {
        ...
        final DoorStatusC01.DCSStatusBean dcsBean = new DoorStatusC01.DCSStatusBean();
        final DoorStatusC01.DoorBean      front   = new DoorStatusC01.DoorBean();
        final DoorStatusC01.DoorBean      rear    = new DoorStatusC01.DoorBean();
        final DoorStatusC01.LoadBean      load    = new DoorStatusC01.LoadBean();

        dcsBean.setFudz(map.get(InputSourceC01.DCS_FUDZ));
        dcsBean.setFldz(map.get(InputSourceC01.DCS_FLDZ));
        dcsBean.setRudz(map.get(InputSourceC01.DCS_RUDZ));
        dcsBean.setRldz(map.get(InputSourceC01.DCS_RLDZ));
        dcsBean.setNdz(map.get(InputSourceC01.DCS_NDZ));
        dcsBean.setUsl(map.get(InputSourceC01.DCS_URL));
        dcsBean.setLsl(map.get(InputSourceC01.DCS_LRL));
        dcsBean.setIns(map.get(InputSourceC01.DCS_INS));
        dcsBean.setInsup(map.get(InputSourceC01.DCS_INS_UP));
        dcsBean.setInsdown(map.get(InputSourceC01.DCS_INS_DOWN));
        // FAN and Light get state from DCS IO state, get invert.
        dcsBean.setFan( map.get(InputSourceC01.DCS_FR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setLight( map.get(InputSourceC01.DCS_LR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON  );
        dcsBean.setDcr( map.get(InputSourceC01.DCS_DCR) );
        dcsBean.setNdr( map.get(InputSourceC01.DCS_NDR)  );
        ...
        front.setDcr(map.get(InputSourceC01.DCS_DCR));
        front.setNdr(map.get(InputSourceC01.DCS_NDR));
        ...
        rear.setDcr(map.get(InputSourceC01.DCS_RDCR));
        rear.setNdr(map.get(InputSourceC01.DCS_RNDR));

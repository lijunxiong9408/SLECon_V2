...
import logic.io.crossbar.InputSourceA01;
...
public class IOStatusA01 extends JPanel implements Page, LiftDataChangedListener, IIOStatus {
    ...
    public IOStatusA01 ( LiftConnectionBean bean) {
    	this.connBean = bean;
    ...
    /*------------------------------------------------------------------------------------------------------------*/        
        ...
        lblInAdo = new InputSourceLabel( "ADO", InputSourceA01.ADO );
        sysPanel.add( lblInAdo, "cell 0 0" );
        lblInV24mon = new InputSourceLabel( "V24MON", InputSourceA01.V24MON );
        sysPanel.add( lblInV24mon, "cell 0 1" );
        lblInEncf = new InputSourceLabel( "ENCF", InputSourceA01.ENCF );
        sysPanel.add( lblInEncf, "cell 0 2" );
        lblInThm = new InputSourceLabel( "THM", InputSourceA01.THM );
        ...
        lblInEnable = new InputSourceLabel( "Enable", InputSourceA01.ENABLE );
        ctrlPanel.add( lblInEnable, "cell 0 0" );
        lblInDbde = new InputSourceLabel( "DBDE", InputSourceA01.DBDE );
        ctrlPanel.add( lblInDbde, "cell 0 1" );
        lblInDbdf = new InputSourceLabel( "DBDF", InputSourceA01.DBDF );
        ctrlPanel.add( lblInDbdf, "cell 0 2" );
        lblInBs1 = new InputSourceLabel( "BS1", InputSourceA01.BS1 );
        ctrlPanel.add( lblInBs1, "cell 1 0" );
        lblInBs2 = new InputSourceLabel( "BS2", InputSourceA01.BS2 );
        ctrlPanel.add( lblInBs2, "cell 1 1" );
        lblInLvcfb = new InputSourceLabel( "LVCFB", InputSourceA01.LVCFB );
        ...
        lblInIns = new InputSourceLabel( "INS", InputSourceA01.INS );
        insectPanel.add( lblInIns, "cell 0 0" );
        lblInInsup = new InputSourceLabel( "INSUP", InputSourceA01.INSUP );
        insectPanel.add( lblInInsup, "cell 0 1" );
        lblInInsdown = new InputSourceLabel( "INSDOWN", InputSourceA01.INSDOWN );
        ...
        lblInDrvenf = new InputSourceLabel( "DRVENF", InputSourceA01.DRVENF );
        driverPanel.add( lblInDrvenf, "cell 2 0" );
        lblInDrvbm = new InputSourceLabel( "DRVBM", InputSourceA01.DRVBM );
        driverPanel.add( lblInDrvbm, "cell 2 1" );
        lblInDrvok = new InputSourceLabel( "DRVOK", InputSourceA01.DRVOK );
        ...
        lblInDfc = new InputSourceLabel( "DFC", InputSourceA01.DFC );
        safePanel.add( lblInDfc, "cell 0 0" );
        lblInDw = new InputSourceLabel( "DW", InputSourceA01.DW );
        safePanel.add( lblInDw, "cell 0 1" );
        lblInHes = new InputSourceLabel( "HES", InputSourceA01.HES );
        safePanel.add( lblInHes, "cell 0 2" );
        lblInCes = new InputSourceLabel( "CES", InputSourceA01.CES );
        safePanel.add( lblInCes, "cell 1 0" );
        lblInUsl = new InputSourceLabel( "USL", InputSourceA01.USL );
        safePanel.add( lblInUsl, "cell 1 1" );
        lblInLsl = new InputSourceLabel( "LSL", InputSourceA01.LSL );
        ...
        lblInUdz = new InputPinLabel( "UDZ", InputPinA01.DCS_UDZ );
        cabinPanel.add( lblInUdz, "cell 0 0" );
        lblInLdz = new InputPinLabel( "LDZ", InputPinA01.DCS_LDZ );
        cabinPanel.add( lblInLdz, "cell 0 1" );
        lblInUrl = new InputPinLabel( "URL", InputPinA01.DCS_URL );
        cabinPanel.add( lblInUrl, "cell 0 2" );
        lblInLrl = new InputPinLabel( "LRL", InputPinA01.DCS_LRL );
        cabinPanel.add( lblInLrl, "cell 1 0" );
        lblInLr = new InputPinLabel( "LR", InputPinA01.DCS_LR );
        cabinPanel.add( lblInLr, "cell 1 1" );
        lblInFr = new InputPinLabel( "FR", InputPinA01.DCS_FR );
        ...
        btnConfigIO.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				StartUI.getTopMain().push(SetupPanel.build(connBean, slecon.setting.setup.io.InputsA01Setting.class));
			}
		} );
    ...
    private static final Object[] updateList = { InputSourceA01.ADO,InputSourceA01.V24MON, InputSourceA01.ENCF, InputSourceA01.THM,
    		InputSourceA01.ENABLE, InputSourceA01.DBDE, InputSourceA01.DBDF, InputSourceA01.BS1,InputSourceA01.BS2, InputSourceA01.LVCFB,
    		InputSourceA01.DRVBM, InputSourceA01.DRVOK, InputSourceA01.DRVENF,InputSourceA01.DFC,InputSourceA01.DW, InputSourceA01.HES, InputSourceA01.CES,
    		InputSourceA01.INS, InputSourceA01.INSUP, InputSourceA01.INSDOWN,InputSourceA01.USL, InputSourceA01.LSL,
    		...
    		InputPinA01.DCS_UDZ, InputPinA01.DCS_LDZ,InputPinA01.DCS_URL, InputPinA01.DCS_LRL,InputPinA01.DCS_LR,InputPinA01.DCS_FR,
    };
    ...
    public void setHot () {
        ...
        for ( Object obj : updateList ) {
            if ( obj instanceof InputSourceA01 ) {
                boolean inputPresent = crossbar.isInputPresent( rawIO, ( InputSourceA01 )obj );
            ...
            }else if(obj instanceof InputPinA01) {
            	 boolean inputPresent = crossbar.isInputPresent( rawIO, ( InputPinA01 )obj );
                 map.put( obj, inputPresent ? OnOffStatus.ON : OnOffStatus.OFF );
            }
        ...
        sb.setAdo( map.get( InputSourceA01.ADO ) );
        sb.setV24mon( map.get( InputSourceA01.V24MON ) );
        sb.setEncf( map.get( InputSourceA01.ENCF ) );
        sb.setThm( map.get( InputSourceA01.THM ) );
        sb.setCcf( map.get( OutputSourceD01.CCF ) );
        ctrlb.setEnable( map.get( InputSourceA01.ENABLE ) );
        ctrlb.setDbde( map.get( InputSourceA01.DBDE ) );
        ctrlb.setDbdf( map.get( InputSourceA01.DBDF ) );
        ctrlb.setBs1( map.get( InputSourceA01.BS1 ) );
        ctrlb.setBs2( map.get( InputSourceA01.BS2 ) );
        ctrlb.setLvcfb( map.get( InputSourceA01.LVCFB ) );
        ...
        db.setDrvenf( map.get( InputSourceA01.DRVENF ) );
        db.setDrvbm( map.get( InputSourceA01.DRVBM ) );
        db.setDrvok( map.get( InputSourceA01.DRVOK ) );
        stb.setDfc( map.get( InputSourceA01.DFC ) );
        stb.setDw( map.get( InputSourceA01.DW ) );
        stb.setHes( map.get( InputSourceA01.HES ) );
        stb.setCes( map.get( InputSourceA01.CES ) );
        stb.setUsl( map.get( InputSourceA01.USL ) );
        stb.setLsl( map.get( InputSourceA01.LSL ) );
        
        cbb.setUdz( map.get( InputPinA01.DCS_UDZ ) );
        cbb.setLdz( map.get( InputPinA01.DCS_LDZ ) );
        cbb.setUsl( map.get( InputPinA01.DCS_URL) );
        cbb.setLsl( map.get( InputPinA01.DCS_LRL ) );
        cbb.setLr( map.get( InputPinA01.DCS_LR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON );
        cbb.setFr( map.get( InputPinA01.DCS_FR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON );
        
        ib.setIns( map.get( InputSourceA01.INS ) );
        ib.setInsup( map.get( InputSourceA01.INSUP ) );
        ib.setInsdown( map.get( InputSourceA01.INSDOWN ) );
    ...
    class InputSourceLabel extends JLabel {
        private InputSourceA01 inputSource;
        ...
        public InputSourceLabel ( String caption, InputSourceA01 is ) {
            super( caption );
            this.inputSource = is;
        }
        ...
        public String getToolTipText () {
            return String.format( TEXT.getString( "IOStatus.TEXT_TOOLTIP_INPUT" ),
                                  ...
                                  : crossbar.getInputPinA01(inputSource),
                                  crossbar == null
    ...
    class OutputSourceLabel extends JLabel {
        ...
        public String getToolTipText () {
            OutputPinA01 pin = null;
            for ( OutputPinA01 p : OutputPinA01.values() ) {
    ...
    class InputPinLabel extends JLabel {
        ...
        public InputPinLabel ( String caption, InputPinA01 in ) {
            super( caption );
            this.inputPin = in;
        }
        ...
        public void update () {
        	if(this.inputPin == InputPinA01.DCS_FR || this.inputPin == InputPinA01.DCS_LR) {
        		setIcon( statusToIcon( Type.OUTPUT, status ) );
        	}else {
        		setIcon( statusToIcon( Type.INPUT, status ) );
        	}
        ...
        public String getToolTipText () {
            return String.format( TEXT.getString( "IOStatus.TEXT_TOOLTIP_INPUT" ),
                                  ...
                                  crossbar == null
                                  ? TEXT.getString( "IOStatus.TEXT_UNASSIGNED" )
                                  : crossbar.getInputPinA01(inputPin),
                                  crossbar == null
                                  ? TEXT.getString( "IOStatus.TEXT_UNASSIGNED_PIN" )
                                  : false
                                    ? TEXT.getString( "IOStatus.TEXT_YES" )

...
public class IOStatusA05 extends JPanel implements Page, LiftDataChangedListener, IIOStatus {
    ...
    public IOStatusA05 ( LiftConnectionBean bean) {
    	this.connBean = bean;
    ...
    /*------------------------------------------------------------------------------------------------------------*/        
        ...
        lblInAdo = new InputSourceLabel( "ADO", InputSourceA05.ADO );
        sysPanel.add( lblInAdo, "cell 0 0" );
        lblInV24mon = new InputSourceLabel( "V24MON", InputSourceA05.V24MON );
        sysPanel.add( lblInV24mon, "cell 0 1" );
        lblInEncf = new InputSourceLabel( "ENCF", InputSourceA05.ENCF );
        sysPanel.add( lblInEncf, "cell 0 2" );
        lblInThm = new InputSourceLabel( "THM", InputSourceA05.THM );
        ...
        lblInEnable = new InputSourceLabel( "Enable", InputSourceA05.ENABLE );
        ctrlPanel.add( lblInEnable, "cell 0 0" );
        lblInDbde = new InputSourceLabel( "DBDE", InputSourceA05.DBDE );
        ctrlPanel.add( lblInDbde, "cell 0 1" );
        lblInDbdf = new InputSourceLabel( "DBDF", InputSourceA05.DBDF );
        ctrlPanel.add( lblInDbdf, "cell 0 2" );
        lblInBs1 = new InputSourceLabel( "BS1", InputSourceA05.BS1 );
        ctrlPanel.add( lblInBs1, "cell 1 0" );
        lblInBs2 = new InputSourceLabel( "BS2", InputSourceA05.BS2 );
        ctrlPanel.add( lblInBs2, "cell 1 1" );
        lblInLvcfb = new InputSourceLabel( "LVCFB", InputSourceA05.LVCFB );
        ...
        lblInIns = new InputSourceLabel( "INS", InputSourceA05.INS );
        insectPanel.add( lblInIns, "cell 0 0" );
        lblInInsup = new InputSourceLabel( "INSUP", InputSourceA05.INSUP );
        insectPanel.add( lblInInsup, "cell 0 1" );
        lblInInsdown = new InputSourceLabel( "INSDOWN", InputSourceA05.INSDOWN );
        ...
        lblInDrvenf = new InputSourceLabel( "DRVENF", InputSourceA05.DRVENF );
        driverPanel.add( lblInDrvenf, "cell 2 0" );
        lblInDrvbm = new InputSourceLabel( "DRVBM", InputSourceA05.DRVBM );
        driverPanel.add( lblInDrvbm, "cell 2 1" );
        lblInDrvok = new InputSourceLabel( "DRVOK", InputSourceA05.DRVOK );
        ...
        lblInDfc = new InputSourceLabel( "DFC", InputSourceA05.DFC );
        safePanel.add( lblInDfc, "cell 0 0" );
        lblInDw = new InputSourceLabel( "DW", InputSourceA05.DW );
        safePanel.add( lblInDw, "cell 0 1" );
        lblInHes = new InputSourceLabel( "HES", InputSourceA05.HES );
        safePanel.add( lblInHes, "cell 0 2" );
        lblInCes = new InputSourceLabel( "CES", InputSourceA05.CES );
        safePanel.add( lblInCes, "cell 1 0" );
        lblInUsl = new InputSourceLabel( "USL", InputSourceA05.USL );
        safePanel.add( lblInUsl, "cell 1 1" );
        lblInLsl = new InputSourceLabel( "LSL", InputSourceA05.LSL );
        ...
        lblInUdz = new InputPinLabel( "UDZ", InputPinA05.DCS_UDZ );
        cabinPanel.add( lblInUdz, "cell 0 0" );
        lblInLdz = new InputPinLabel( "LDZ", InputPinA05.DCS_LDZ );
        cabinPanel.add( lblInLdz, "cell 0 1" );
        lblInUrl = new InputPinLabel( "URL", InputPinA05.DCS_URL );
        cabinPanel.add( lblInUrl, "cell 0 2" );
        lblInLrl = new InputPinLabel( "LRL", InputPinA05.DCS_LRL );
        cabinPanel.add( lblInLrl, "cell 1 0" );
        lblInLr = new InputPinLabel( "LR", InputPinA05.DCS_LR );
        cabinPanel.add( lblInLr, "cell 1 1" );
        lblInFr = new InputPinLabel( "FR", InputPinA05.DCS_FR );
    ...
    private static final Object[] updateList = { InputSourceA05.ADO,InputSourceA05.V24MON, InputSourceA05.ENCF, InputSourceA05.THM,
    		InputSourceA05.ENABLE, InputSourceA05.DBDE, InputSourceA05.DBDF, InputSourceA05.BS1,InputSourceA05.BS2, InputSourceA05.LVCFB,
    		InputSourceA05.DRVBM, InputSourceA05.DRVOK, InputSourceA05.DRVENF,InputSourceA05.DFC,InputSourceA05.DW, InputSourceA05.HES, InputSourceA05.CES,
    		InputSourceA05.INS, InputSourceA05.INSUP, InputSourceA05.INSDOWN,InputSourceA05.USL, InputSourceA05.LSL,
    		...
    		InputPinA05.DCS_UDZ, InputPinA05.DCS_LDZ,InputPinA05.DCS_URL, InputPinA05.DCS_LRL,InputPinA05.DCS_LR,InputPinA05.DCS_FR,
    };
    ...
    public void setHot () {
        ...
        for ( Object obj : updateList ) {
            if ( obj instanceof InputSourceA05 ) {
            ...
            }else if(obj instanceof InputPinA05) {
            	 boolean inputPresent = crossbar.isInputPresent( rawIO, ( InputPinA05 )obj );
                 map.put( obj, inputPresent ? OnOffStatus.ON : OnOffStatus.OFF );
            }
        ...
        sb.setAdo( map.get( InputSourceA05.ADO ) );
        sb.setV24mon( map.get( InputSourceA05.V24MON ) );
        sb.setEncf( map.get( InputSourceA05.ENCF ) );
        sb.setThm( map.get( InputSourceA05.THM ) );
        sb.setCcf( map.get( OutputSourceD01.CCF ) );
        ctrlb.setEnable( map.get( InputSourceA05.ENABLE ) );
        ctrlb.setDbde( map.get( InputSourceA05.DBDE ) );
        ctrlb.setDbdf( map.get( InputSourceA05.DBDF ) );
        ctrlb.setBs1( map.get( InputSourceA05.BS1 ) );
        ctrlb.setBs2( map.get( InputSourceA05.BS2 ) );
        ctrlb.setLvcfb( map.get( InputSourceA05.LVCFB ) );
        ...
        db.setDrvenf( map.get( InputSourceA05.DRVENF ) );
        db.setDrvbm( map.get( InputSourceA05.DRVBM ) );
        db.setDrvok( map.get( InputSourceA05.DRVOK ) );
        stb.setDfc( map.get( InputSourceA05.DFC ) );
        stb.setDw( map.get( InputSourceA05.DW ) );
        stb.setHes( map.get( InputSourceA05.HES ) );
        stb.setCes( map.get( InputSourceA05.CES ) );
        stb.setUsl( map.get( InputSourceA05.USL ) );
        stb.setLsl( map.get( InputSourceA05.LSL ) );
        
        cbb.setUdz( map.get( InputPinA05.DCS_UDZ ) );
        cbb.setLdz( map.get( InputPinA05.DCS_LDZ ) );
        cbb.setUsl( map.get( InputPinA05.DCS_URL) );
        cbb.setLsl( map.get( InputPinA05.DCS_LRL ) );
        cbb.setLr( map.get( InputPinA05.DCS_LR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON );
        cbb.setFr( map.get( InputPinA05.DCS_FR) == OnOffStatus.ON ? OnOffStatus.OFF : OnOffStatus.ON );
        
        ib.setIns( map.get( InputSourceA05.INS ) );
        ib.setInsup( map.get( InputSourceA05.INSUP ) );
        ib.setInsdown( map.get( InputSourceA05.INSDOWN ) );
    ...
    class InputSourceLabel extends JLabel {
        private InputSourceA05 inputSource;
        ...
        public InputSourceLabel ( String caption, InputSourceA05 is ) {
            super( caption );
            this.inputSource = is;
        }
        ...
        public String getToolTipText () {
            return String.format( TEXT.getString( "IOStatus.TEXT_TOOLTIP_INPUT" ),
                                  ...
                                  : crossbar.getInputPinA05(inputSource),
                                  crossbar == null
    ...
    class OutputSourceLabel extends JLabel {
        ...
        public String getToolTipText () {
            OutputPinA05 pin = null;
            for ( OutputPinA05 p : OutputPinA05.values() ) {
    ...
    class InputPinLabel extends JLabel {
        ...
        public InputPinLabel ( String caption, InputPinA05 in ) {
            super( caption );
            this.inputPin = in;
        }
        ...
        public void update () {
        	if(this.inputPin == InputPinA05.DCS_FR || this.inputPin == InputPinA05.DCS_LR) {
        		setIcon( statusToIcon( Type.OUTPUT, status ) );
        	}else {
        		setIcon( statusToIcon( Type.INPUT, status ) );
        	}
        ...
        public String getToolTipText () {
            return String.format( TEXT.getString( "IOStatus.TEXT_TOOLTIP_INPUT" ),
                                  ...
                                  crossbar == null
                                  ? TEXT.getString( "IOStatus.TEXT_UNASSIGNED" )
                                  : crossbar.getInputPinA05(inputPin),
                                  crossbar == null
                                  ? TEXT.getString( "IOStatus.TEXT_UNASSIGNED_PIN" )
                                  : false
                                    ? TEXT.getString( "IOStatus.TEXT_YES" )

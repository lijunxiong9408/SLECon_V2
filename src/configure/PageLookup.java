...
public final class PageLookup {
    ...
    static {
        ...
        setup.add( new DisplayTreeItem( 0x0304, "Modules::Motor_OverHeating_Operation", slecon.setting.modules.MotorOverHeatingOperationSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x0305, "Modules::Earthquake Operation", slecon.setting.modules.EarthQuakeOperationSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x0306, "Modules::Temperature Detector Emergency Operation", slecon.setting.modules.TemperatureDetectorEmergencyOperationSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x0307, "Modules::Fire Emergency Return Operation", slecon.setting.modules.FireEmergencyReturnOperationSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x0308, "Modules::Fireman's Emergency Operation", slecon.setting.modules.FiremansEmergencyOperationSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x0309, "Modules::Emergency Battery Operation", slecon.setting.modules.EmergencyBatteryOperationSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x030a, "Modules::Emergency Power Operation", slecon.setting.modules.EmergencyPowerOperationSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x030b, "Modules::Attendant Service Operation", slecon.setting.modules.AttendantServiceOperationSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x030c, "Modules::Independent Services", slecon.setting.modules.IndependentServiceSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x030d, "Modules::Parking", slecon.setting.modules.ParkingSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x030e, "Modules::FullLoad Operation", slecon.setting.modules.FullLoadOperationSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x030f, "Modules::Overload protection", slecon.setting.modules.OverloadProtectionSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x0310, "Modules::Fault State Group Suspension", slecon.setting.modules.FaultStateGroupSuspensionSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x0311, "Modules::Access Control", slecon.setting.modules.AccessControlSetting.class, "read_ocs" ) );
        setup.add( new DisplayTreeItem( 0x0312, "Modules::Car Call Option", slecon.setting.modules.CarCallOptionSetting.class, "read_ocs" ) );
